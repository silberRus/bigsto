...
//
// Возвращаемое значение:
//  СправочникСсылка.МобильныеПриложения - группа справочника, соответствующая мобильному приложения. Если не найдено - возвращается пустая ссылка.
//
...
//  ВерсияМобильногоПриложения - СправочникСсылка.ВерсииМобильныхПриложений - версия мобильного приложения, для которого необходимо получить элемент.
//
// Возвращаемое значение:
//  СправочникСсылка.ВерсииМобильныхПриложений - элемент справочника, соответствующий указанной версии мобильного приложения.Если не найдено - возвращается пустая ссылка.
//
...
//
// Параметры:
//  Узел обмена - ПланОбменаСсылка - узел плана обмена, для которого необходимо зарегистрировать изменение данных.
//  СтруктураПараметровОбменаДанными - Структура - структура, содержащая параметры обмена данными.
...
Функция СформироватьПакетОбмена(УзелОбмена, СтруктураПараметровОбменаДанными, НачальнаяИнициализацияИБ) Экспорт
	...
	ДеревоИспользуемыхМетаданных = ИспользуемыеМетаданные(УзелОбмена.ВерсияМобильногоПриложения.ИспользуемыеМетаданные);
...
//  УзелОбмена - ПламОбменаСсылка - узел плана обмена, в котором регистрируются изменения.
//
// Возвращаемое значение:
//  Булево - Признак необходимости регистрации изменений по объекту. Истина - регистрация требуется. Ложь - регистрация не требуется.
//
...
//  НомерСообшения - Число - номер сообщения обмена.
//
// Возвращаемое значение:
...
//  Вид сравнения - ВидСравненияКомпоновкиДанных - вид сравнения компоновки данных
//  Использование - Булево - использование элемента отбора
//  ПравоеЗначение - ПроизвольныйТип - правое значение сравнения.
//
...
//  ПравоеЗначение - ПроизвольныйТип - правое значение в отборе.
//
...
//  Значение - Произвольный тип - устанавливаемое значение параметра.
//
...
//  Структура отбора - Структура - структура, содержащая данные для заполнения отбора.
//
...
//  ИспользоватьДополнительныеОтборы - Булево - признак необходимости установки доп. отборов для регистров (помимо ключевых полей).
...
//      * ИспользованиеКонтактнойИнформации - ПеречислениеСсылка.ИспользованиеКонтактнойИнформацииМобильнымПриложением - вид использования контактной информации.
//      * ИспользованиеСоглашенийСКлиентами - ПеречислениеСсылка.ИспользованиеСоглашенийСКлиентами - вид использования соглашений с клиентами.
//
...
//
// Возвращаемое значение:
//  ДеревоЗначений - сформированное дерево значений, содержащее данные по используемым метаданным.
//
...
//  СоставОбъекта - структура, описывающая состав объекта данных.
...
//  СоставОбъекта - структура, описывающая состав объекта.
//
// Возвращаемое значение:
...
//  СоставОбъекта - структура, описывающая состав объекта метаданных.
//
// Возвращаемое значение:
...
//  СоставОбъекта - структура, содержащая описание объекта.
//
// Возвращаемое значение:
//  Тип - тип реквизита.
//
...
//  СтруктураПараметровНастройкиОбмена - структура, содержащая параметры настройки обмена.
//  ДополнительныеПараметры - структура, содержащая следующие дополнительные параметры:
