...
Функция ПодсказкаВДокументе(ПараметрыПрорисовки, СостояниеПроверки) Экспорт
	...
	Цвета = ПроверкаКонтрагентов.ЦветаРезультатовПроверки();
	#Иначе
	Цвета = ПроверкаКонтрагентовКлиент.ЦветаРезультатовПроверки();
	#КонецЕсли
...
Функция СвойстваСправочникаКонтрагенты(Ссылка, ИсключениеПриОтсутствииОписания = Истина) Экспорт
	...
	Возврат РаботаСКонтрагентами.СвойстваСправочникаКонтрагенты(Ссылка, ИсключениеПриОтсутствииОписания);
	...
	СвойстваСправочников = ПараметрыИПП.РаботаСКонтрагентами.СвойстваСправочниковКонтрагентов;
	Для Каждого СвойстваСправочника Из СвойстваСправочников Цикл
		Если СвойстваСправочника.ТипСсылка = ТипСсылка Тогда
			Возврат СвойстваСправочника;
		КонецЕсли;
	КонецЦикла;
	
	Если ИсключениеПриОтсутствииОписания Тогда
