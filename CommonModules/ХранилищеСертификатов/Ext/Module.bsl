...
Функция СертификатВКодировкеDER(Сертификат) Экспорт
...
Функция ИмяСобытияУдалениеФайла()
	...
	Возврат НСтр("ru = 'Хранилище сертификатов.Удаление файла'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
