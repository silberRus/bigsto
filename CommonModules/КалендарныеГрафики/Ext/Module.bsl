...
// Возвращает производственный календарь, составленный в соответствии с ст. 112 ТК РФ.
//
// Возвращаемое значение:
//   СправочникСсылка.ПроизводственныеКалендари, Неопределено - производственный календарь РФ или 
//     Неопределено, в случае если он не обнаружен.
//
...
//	 ТаблицаЗначений.
//
Функция ТаблицаПроизводственныхКалендарей() Экспорт
...
Процедура ОбновитьПроизводственныеКалендари() Экспорт
	...
	ТаблицаКалендарей = ТаблицаПроизводственныхКалендарей();
