...
//                    **** РазделенныеДанные - Булево - какие данные будут проверяться, в зависимости от этого значения, в
//                           разных режимах будут показаны разные проверки.
...
//
// Пример:
//   Обработчики.Вставить(Новый УникальныйИдентификатор("2b1043e2-9e00-4518-ac0d-1a2befdcce1x"), "Обработки.ПроверкаИзмеренийВРегистрахБухгалтерии");
//
