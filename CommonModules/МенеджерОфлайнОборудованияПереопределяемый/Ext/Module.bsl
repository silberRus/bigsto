...
Процедура ФормаНастройкиОфлайнОборудованияПриСозданииНаСервере(Форма, ОфлайнОборудование) Экспорт
	...
	Если ОфлайнОборудование.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ККМОфлайн
		...
		ЭлементСохранятьЦенники.Заголовок = "Сохранять ценники в конфигурации";
		...
		ЭлементПринтерПечати.Заголовок = "Принтер печати";
		...
		ЭлементШаблонЦенника.Заголовок = "Шаблон ценника";
