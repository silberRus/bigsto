...
//
// Параметры:
//		ЭтотОбъект- ДокументОбъект - документ, в ТЧ которого нужно проверить заполнение колонки "Склад",
...
//
// Параметры:
//	Форма	 - УправляемаяФорма - форма из которой осуществляется открытие формы 
...
//	ЕстьОтменаСтрок - Булево, Истина - ТекущиеДанные и КешСтрооки содержат поле "Отменено".
//
