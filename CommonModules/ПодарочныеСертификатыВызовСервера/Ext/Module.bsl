...
//  Структура - см. функцию ПолучитьСтруктуруДанныхПодарочногоСертификата().
//
...
//   * ВидПодарочногоСертификата - ПеречислениеСсылка.ВидыПодарочныхСертификатов - Вид подарочного сертификата.
...
//   * ПериодДействия - СправочникСсылка.Периодичность - Период действия подарочного сертификата.
...
//
// Параметры:
//  СтруктураДанныхПодарочногоСертификата - Структура - Данные подарочного сертификата, см. функцию ПолучитьСтруктуруДанныхПодарочногоСертификата().
//
// Возвращаемое значение:
...
// Возвращаемое значение:
//  Структура - Структура со свойствами:
//   * ЗарегистрированныеПодарочныеСертификаты - ТаблицаЗначений - Незарегистрированные подарочные сертификаты, см функцию
//                                                                 ПолучитьСтруктуруДанныхПодарочногоСертификата().
//   * НеЗарегистрированныеПодарочныеСертификаты - ТаблицаЗначений - Незарегистрированные подарочные сертификаты, см функцию
//                                                                   ПолучитьСтруктуруДанныхПодарочногоСертификата().
//
