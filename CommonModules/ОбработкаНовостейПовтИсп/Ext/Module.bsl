...
Функция ПолучитьАдресДляПолученияНовостей(
	...
	Если Найти(лкИмяФайлаНаСервере, "[from]") > 0 Тогда
		...
		Иначе
			...
			лкИмяФайлаНаСервере = СтрЗаменить(лкИмяФайлаНаСервере, "[from]", "last=100");
		КонецЕсли;
	КонецЕсли;
