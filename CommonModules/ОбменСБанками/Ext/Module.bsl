...
Процедура ПолучитьДанныеВыпискиБанкаДеревоЗначений(ЭлектронныеДокументы, ДанныеВыписки) Экспорт
	...
	Для Каждого СообщениеОбмена Из МассивСообщенийОбмена Цикл
		...
		СтруктураДанных = ОбменСБанкамиСлужебный.СформироватьДеревоРазбора(ДанныеЭД, СообщениеОбмена.Направление);
...
Процедура ПолучитьДанныеВыпискиБанкаТекстовыйФормат(Знач СообщениеОбмена, СсылкаНаХранилище, МассивСчетов = Неопределено) Экспорт
	...
	Для Каждого ВыпискаБанка Из МассивСообщений Цикл
		...
		СтруктураДанных = ОбменСБанкамиСлужебный.СформироватьДеревоРазбора(ДанныеЭД, РеквизитыСообщения.Направление);
...
Функция ДеревоРазбораВыпискиБанка(ТекстДляРазбора) Экспорт
	...
	ДвоичныеДанные = ОбменСБанкамиСлужебный.ДвоичныеДанныеИзXDTO(ФабрикаXDTO, ClientBankExchange);
	
	СтруктураДанных = ОбменСБанкамиСлужебный.СформироватьДеревоРазбора(ДвоичныеДанные, Перечисления.НаправленияЭД.Входящий);
