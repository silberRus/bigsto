...
Процедура ПолучитьРезультатыОбработкиЗапросовСбербанк(Знач НастройкаОбмена, ВидЭД, Параметры)
	...
	МассивИдентификаторов = ОбменСБанкамиСлужебныйВызовСервера.МассивИдентификаторовЗапроса(
		НастройкаОбмена, ВидЭД, ИдентификаторОрганизации);
...
Процедура ПослеОтправкиПакетаЧерезВК(РезультатВызова, ПараметрыВызова, ДополнительныеПараметры) Экспорт
	...
	Исключение
		...
		ОбработатьОшибку(ВидОперации, ТекстИсключения, , ДополнительныеПараметры.ПакетЭД);
