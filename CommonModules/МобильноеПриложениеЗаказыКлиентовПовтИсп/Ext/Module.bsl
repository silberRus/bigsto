...
Функция СтруктураДоговора() Экспорт
	...
	СтруктураДоговора.Вставить("РасчетыПоДоговору");
	СтруктураДоговора.Вставить("СуммаДолгаПоДоговору");
...
Функция СтруктураДопРеквизита() Экспорт
	...
	СтруктураДопРеквизита.Вставить("ПометкаУдаления");
	СтруктураДопРеквизита.Вставить("Наименование");
	СтруктураДопРеквизита.Вставить("ИмяПредопределенныхДанных");
	СтруктураДопРеквизита.Вставить("Виден");
	СтруктураДопРеквизита.Вставить("ВладелецДополнительныхЗначений");
	СтруктураДопРеквизита.Вставить("ДополнительныеЗначенияИспользуются");
	СтруктураДопРеквизита.Вставить("ДополнительныеЗначенияСВесом");
	СтруктураДопРеквизита.Вставить("Доступен");
	СтруктураДопРеквизита.Вставить("Заголовок");
	СтруктураДопРеквизита.Вставить("ЗаголовокФормыВыбораЗначения");
	СтруктураДопРеквизита.Вставить("ЗаголовокФормыЗначения");
	СтруктураДопРеквизита.Вставить("ЗаполнятьОбязательно");
	СтруктураДопРеквизита.Вставить("МногострочноеПолеВвода");
	СтруктураДопРеквизита.Вставить("НаборСвойств");
	СтруктураДопРеквизита.Вставить("ТипЗначения");
	СтруктураДопРеквизита.Вставить("ФорматСвойства");
	СтруктураДопРеквизита.Вставить("ЭтоДополнительноеСведение");
	СтруктураДопРеквизита.Вставить("ЗависимостиДополнительныхРеквизитов");
...
Функция СтруктураКонтрагента() Экспорт
	...
	СтруктураКонтрагента.Вставить("ИНН");
	СтруктураКонтрагента.Вставить("ИННКПП");
	СтруктураКонтрагента.Вставить("Клиент");
	СтруктураКонтрагента.Вставить("КПП");
...
Функция СтруктураНоменклатуры() Экспорт
	...
	СтруктураНоменклатуры.Вставить("ДополнительныеРеквизиты");
...
Функция СтруктураПартнера() Экспорт
	...
	СтруктураПартнера.Вставить("ДополнительныеРеквизиты");
...
Функция СтруктураОрганизации() Экспорт
	...
	СтруктураОрганизации.Вставить("Руководитель");
	СтруктураОрганизации.Вставить("ГлавныйБухгалтер");
	СтруктураОрганизации.Вставить("ИНН");
	СтруктураОрганизации.Вставить("КПП");
	СтруктураОрганизации.Вставить("СвидетельствоСерияНомер");
	СтруктураОрганизации.Вставить("СвидетельствоДатаВыдачи");
	СтруктураОрганизации.Вставить("НаименованиеПолное");
	СтруктураОрганизации.Вставить("ЮрФизЛицо");
	
	СтруктураОрганизации.Вставить("НомерСчета");
	СтруктураОрганизации.Вставить("Банк");
	СтруктураОрганизации.Вставить("БИК");
	СтруктураОрганизации.Вставить("ГородБанка");
	СтруктураОрганизации.Вставить("КоррСчет");
	
	СтруктураОрганизации.Вставить("КонтактнаяИнформация");
	СтруктураОрганизации.Вставить("ДополнительныеРеквизиты");
