...
Функция СтруктураИзСтрокиJSON(Строка) Экспорт
...
Функция СтруктураИзПотокаJSON(ПотокДанных) Экспорт
...
Процедура ПодготовитьОбластьИзВыгрузки(Знач КодОбластиДанных, Знач ИдентификаторВыгрузки, Знач СопоставлениеПользователей) Экспорт
	...
	Попытка
		...
		МодульВыгрузкаЗагрузкаОбластейДанных.ЗагрузитьТекущуюОбластьДанныхИзАрхива(ИмяФайлаВыгрузки, , , СопоставлениеПользователей);
