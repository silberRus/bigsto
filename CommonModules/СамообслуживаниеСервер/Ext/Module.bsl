...
Процедура ОформитьЗаказ(СтруктураЗаказа, Проводить = Истина) Экспорт
	...
	Если ЗначениеЗаполнено(ДокументЗаказ.Договор) Тогда
		...
		ДокументЗаказ.ПорядокОплаты = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДокументЗаказ.Договор,"ПорядокОплаты");
	...
	Иначе
		...
		ДокументЗаказ.ПорядокОплаты = Перечисления.ПорядокОплатыПоСоглашениям.ПолучитьПорядокОплатыПоУмолчанию(ДокументЗаказ.Валюта,
																									ДокументЗаказ.НалогообложениеНДС,
																									ВалютаОплаты);
