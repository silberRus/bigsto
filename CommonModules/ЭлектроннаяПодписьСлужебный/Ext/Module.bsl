...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Если Метаданные.Обработки.Найти("ПрограммыЭлектроннойПодписиИШифрования") <> Неопределено Тогда
		...
		Обработчик.Процедура = "Обработки.ПрограммыЭлектроннойПодписиИШифрования.ЗаполнитьНачальныеНастройки";
		...
		Обработчик.Процедура = "Обработки.ПрограммыЭлектроннойПодписиИШифрования.ОбработатьДанныеДляПереходаНаНовуюВерсию";
		Обработчик.РежимВыполнения = "Отложенно";
		Обработчик.ПроцедураЗаполненияДанныхОбновления = "Обработки.ПрограммыЭлектроннойПодписиИШифрования.ЗарегистрироватьДанныеКОбработкеДляПереходаНаНовуюВерсию";
...
Функция СведенияОПодписиДляЖурналаРегистрации(ДатаПодписи, СвойстваПодписи, ЭтоОшибкаПодписания = Ложь) Экспорт
	...
	Иначе
		...
		СвойстваСертификата.Вставить("ДатаНачала",    "");
		СвойстваСертификата.Вставить("ДатаОкончания", "");
		...
		Если ТипЗнч(Сертификат) = Тип("ДвоичныеДанные") Тогда
			...
			СвойстваСертификатаКриптографии = ЭлектроннаяПодписьКлиентСервер.ЗаполнитьСтруктуруСертификата(СертификатКриптографии);
			ДатыСертификата                 = ЭлектроннаяПодписьСлужебныйКлиентСервер.ДатыСертификата(СертификатКриптографии);
			
			СвойстваСертификата.СерийныйНомер = Строка(СертификатКриптографии.СерийныйНомер);
			СвойстваСертификата.КемВыдан      = СвойстваСертификатаКриптографии.КемВыдан;
			СвойстваСертификата.КомуВыдан     = СвойстваСертификатаКриптографии.КомуВыдан;
			СвойстваСертификата.ДатаНачала    = Формат(ДатыСертификата.ДатаНачала,    "ДЛФ=D");
			СвойстваСертификата.ДатаОкончания = Формат(ДатыСертификата.ДатаОкончания, "ДЛФ=D");
