...
//
// Параметры:
//  Объект - СправочникОбъект.СкидкиНаценки - Элемент справочника
//
...
//
// Параметры:
//  ЭлементыОтбора - ЭлементОтбораКомпоновкиДанных - Элемент отбора
