...
Процедура ОбновитьУслугу(ЗначенияРеквизитов) Экспорт
	...
	ИдентификаторПоставщика = ТехнологияСервисаИнтеграцияСБСП.ЗначениеРеквизитаОбъекта(ЗначенияРеквизитов.ПоставщикУслуги, "Идентификатор");
	
	УслугаСсылка = Тарификация.УслугаПоИдентификаторуИИдентификаторуПоставщика(ЗначенияРеквизитов.Идентификатор, ИдентификаторПоставщика, Ложь);
...
Функция ПолучитьОтветОтHTTPСервиса(ПараметрыПодключения, ШаблонURL, Метод, ПараметрыЗапроса)
	...
	ЗащищенноеСоединение = ?(ВРег(СтруктураURI.Схема) = "HTTPS", Новый ЗащищенноеСоединениеOpenSSL(, Новый СертификатыУдостоверяющихЦентровОС), Неопределено);
