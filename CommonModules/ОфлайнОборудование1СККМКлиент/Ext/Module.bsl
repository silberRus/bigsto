...
Процедура НачатьВыгрузкуДанныхЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	ОфлайнОборудование1СККМВызовСервера.ЗаписатьДанныеВыгрузкиВФайл(
		ИмяФайла,
...
Процедура ОповещениеПоискФайловУстановкаФлагаДанныеЗагружены(НайденныеФайлы, ДополнительныеПараметры) Экспорт
	...
	Успешно = ОфлайнОборудование1СККМВызовСервера.УстановитьФлагДанныеЗагружены(ИменаФайлов, ВыходныеПараметры, Параметры.ВерсияФорматаОбмена);
