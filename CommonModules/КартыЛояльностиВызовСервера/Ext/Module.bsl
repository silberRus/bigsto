...
//  Структура - Данные карты лояльности, см. функцию КартыЛояльностиСервер.ПолучитьСтруктуруДанныхКартыЛояльности().
//
...
//                                           см. функцию КартыЛояльностиСервер.ПолучитьСтруктуруДанныхКартыЛояльности().
