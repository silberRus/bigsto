...
//     * ФормаОплаты             - ПеречислениеСсылка.ФормыОплаты - Форма оплаты, по которой определяется необходимость получения банковского счета.
...
// 
// Возвращаемое значение:
//  ФиксированнаяСтруктура - см. Справочники.Номенклатура.ВсеРеквизитыНоменклатуры
//
...
// 
// Возвращаемое значение:
//  ФиксированнаяСтруктура - см. Справочники.ХарактеристикиНоменклатуры.ХарактеристикиНоменклатуры
//
Функция ВсеРеквизитыХарактеристикНоменклатуры(ТипНоменклатуры,
									ОсобенностьУчета,
									ВариантОказанияУслуг) Экспорт
	
	Возврат Справочники.ХарактеристикиНоменклатуры.ВсеРеквизиты(ТипНоменклатуры, ОсобенностьУчета, ВариантОказанияУслуг);
...
// 
// Возвращаемое значение:
//  ТаблицаЗначений - колонки таблицы такие же, как свойства в структуре см. Справочники.ХарактеристикиНоменклатуры.ХарактеристикиНоменклатуры
//
Функция ВсеРеквизитыХарактеристикНоменклатурыТаблица(ТипНоменклатуры,
	...
	ВсеРеквизитыХарактеристикНоменклатурыСтруктура =
			ЗначениеНастроекПовтИсп.ВсеРеквизитыХарактеристикНоменклатуры(ТипНоменклатуры, ОсобенностьУчета, ВариантОказанияУслуг);
...
//
// Возвращаемое значение:
//  ПеречислениеСсылка.ТипыНалогообложенияНДС - налогообложение НДС по умолчанию.
//
Функция ПолучитьНалогообложениеНДС(Знач Организация, Знач Склад = Неопределено, Знач Дата = Неопределено) Экспорт
...
//   * Организация - СправочникСсылка.Организации - Организация, для которой необходимо получить счет
//   * ФормаОплаты - ПеречислениеСсылка.ФормыОплаты - Форма оплаты, по которой определяется необходимость олучения кассы.
...
//
// Возвращаемое значение:
//   СправочникСсылка.Кассы - касса органнизации по умолчанию.
//
...
//
// Возвращаемое значение:
//   СправочникСсылка.ВидЦены - вид цены по умолчанию.
//
