...
Процедура ПриИзмененииСтатусаЧека(ДокументСсылка, ПредыдущийСтатус, НовыйСтатус, ПараметрыОбновленияСтатуса) Экспорт
	...
	Если ДобавитьДвижения Тогда
		...
		ШтрихкодыУпаковок = МенеджерОбъекта.ШтрихкодыУпаковок(ДокументСсылка);
...
Функция ЧекЕГАИСXML(ДокументСсылка, РезультатыЗапроса, МенеджерВременныхТаблиц) Экспорт
