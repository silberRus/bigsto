...
//
// Возвращаемое значение:
// 	Соответствие колонок имеющих следущие свойства:
...
Функция ТипыКолонокПечатиПоТипуШтрихкода(ТипШтрихкода) Экспорт
	...
	Если ТипШтрихкода = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.Code128") Тогда
		...
		ТипыКолонок.Вставить("НомерПоПорядку", Новый ОписаниеТипов("Число",,,Новый КвалификаторыЧисла(7,0,ДопустимыйЗнак.Неотрицательный)));
	...
	ИначеЕсли ТипШтрихкода = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.GS1_128")
		...
		КонецЦикла;
	ИначеЕсли ТипШтрихкода = ПредопределенноеЗначение("Перечисление.ТипыШтрихкодов.PDF417") Тогда
