...
//
// Параметры:
//  Ссылка     - СправочникСсылка.СегментыНоменклатуры, СправочникСсылка.СегментыПартнеров - сегмент, чьи СКД и настройки получаются.
//  ИмяШаблона - Строка - имя шаблона сегмента.
//
// Возвращаемое значение:
//   Структура   -  сотоит из следующих полей
//       Описание                - Строка - описание сегмента
//       СхемаКомпоновкиДанных   - СхемаКомпоновкиДанных - СКД шаблона.
//       АдресСКД                - НастройкиКомпоновкиДанных -настройки СКД шаблона.
//
...
//
// Параметры:
//  Форма   - УправляемаяФорма - создаваемая форма элемента сегмента партнеров или номенклатуры.
...
//
// Параметры:
//  Объект           - СправочникОбъект.СегментПартнеров, СправочникОбъект.СегментНоменклатуры - копируемый объект.
//  ДанныеЗаполнения - Произовльный - Значение, которое используется как основание для заполнения.
//
...
//
// Параметры:
//  ТипСегмента  - ТипСегмента - указывает на то, какого типа сегмент.
//
// Возвращаемое значение:
...
//  Сегмент       - СправочникСсылка.СегментНоменклатуры - сегмент, в которых входя характеристики номенклатуры.
//
// Возвращаемое значение:
...
//  СегментСсылка  - СправочникСсылка.СегментыНоменклатуры, СправочникСсылка.СегментыПартнеров - ссылка на сегмент партнеров или номенклатуры.,
