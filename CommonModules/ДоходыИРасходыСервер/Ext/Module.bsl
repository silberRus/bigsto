...
//	ТекущиеДанные - Структура - данные документа для заполнения статьи и аналитики.
//
...
//
// Параметры:
//	СтатьяРасходов - ПланВидовХарактеристик.СтатьиРасходов - Выбранная статья расходов
...
//
// Параметры:
//	СтатьяАктивовПассивов - ПланВидовХарактеристик.СтатьиАктивовПассивов - Выбранная статья активов и пассивов
...
// 
// Параметры:
//	ТаблицаФормы - ДанныеФормыКоллекция - данные управляемой формы.
...
// 	ИмяРеквизита - Строка - Имя реквизита статьи расходов, доходов или активов/пассивов
//
Процедура ИнициализироватьПустоеЗначениеСтатьиВТЧ(ТабличнаяЧасть, ИмяРеквизита) Экспорт
...
//
// Параметры:
// 	 Форма - УправляемаяФорма - Форма, в которой для которой необходимо условное оформление формы
...
// Процедура формирования движений по регистру "Прочие доходы".
//
// Параметры:
...
// Процедура формирования движений по регистру "Прочие расходы".
//
// Параметры:
//	ДополнительныеСвойства - Структура - дополнительные значения, связанные с документом.
//	Движения - КоллекцияДвижений - коллекция наборов записей движений документа.
...
// Процедура формирования движений по регистру "Выручка и себестоимость продаж".
//
// Параметры:
//	ДополнительныеСвойства - Структура - дополнительные значения, связанные с документом.
//	Движения - КоллекцияДвижений - коллекция наборов записей движений документа.
...
//	Отказ - Булево - признак отказа от проведения документа.
//
Процедура ОтразитьНДСПредъявленный(ДополнительныеСвойства, Движения, Отказ) Экспорт
	...
	Если не Движения.НДСПредъявленный.ДополнительныеСвойства.Свойство("ДляПроведения") Тогда
		Движения.НДСПредъявленный.ДополнительныеСвойства.Вставить("ДляПроведения");
	КонецЕсли;
...
// Процедура формирования движений по регистру "Журнал учета счетов-фактур"
//
// Параметры:
//	ДополнительныеСвойства - Структура - дополнительные значения, связанные с документом.
//	Движения - КоллекцияДвижений - коллекция наборов записей движений документа.
...
// Процедура формирования движений по регистру "НДС состояние реализации 0%"
//
// Параметры:
//	ДополнительныеСвойства - Структура - дополнительные значения, связанные с документом.
//	Движения - КоллекцияДвижений - коллекция наборов записей движений документа.
