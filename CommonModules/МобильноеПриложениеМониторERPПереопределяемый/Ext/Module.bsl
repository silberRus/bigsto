////////////////////////////////////////////////////////////////////////////////
// МОДУЛЬ СОДЕРЖИТ МЕТОДЫ ДЛЯ РАБОТЫ С ОБМЕНОМ С МОБИЛЬНЫМ ПРИЛОЖЕНИЕМ "1С:МОНИТОР ERP"
//
////////////////////////////////////////////////////////////////////////////////
...
Процедура ВыгрузитьОсновныеСправочники(Фабрика, ЗаписьXML) Экспорт
	...
	|ПОМЕСТИТЬ ВидыКонтактнойИнформации
	|ИЗ
	|	(ВЫБРАТЬ
	...
	|		И ВидыКонтактнойИнформации.Ссылка В ИЕРАРХИИ (ЗНАЧЕНИЕ(Справочник.ВидыКонтактнойИнформации.СправочникПартнеры))
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	|	
	|	ВЫБРАТЬ
	...
	|	ГДЕ
	|		НЕ ВидыКонтактнойИнформации.ЭтоГруппа
	|		И ВидыКонтактнойИнформации.Ссылка В ИЕРАРХИИ (ЗНАЧЕНИЕ(Справочник.ВидыКонтактнойИнформации.СправочникКонтактныеЛицаПартнеров))) КАК ВидыКонтактнойИнформации
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	СправочникиДляВыгрузки.Страна КАК СтранаСсылка,
	|	СправочникиДляВыгрузки.ВидКонтактнойИнформации КАК ВидКИСсылка
	|ПОМЕСТИТЬ СправочникиДляВыгрузки
	|ИЗ
	|	(ВЫБРАТЬ
	|		Страны.Страна КАК Страна,
	|		NULL КАК ВидКонтактнойИнформации
	|	ИЗ
	|		Страны КАК Страны
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	...
	|	ИЗ
	|		ВидыКонтактнойИнформации КАК ВидыКонтактнойИнформации) КАК СправочникиДляВыгрузки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	СправочникиДляВыгрузки.СтранаСсылка КАК СтранаСсылка,
	|	СправочникиДляВыгрузки.СтранаСсылка.ПометкаУдаления КАК СтранаПометкаУдаления,
	|	СправочникиДляВыгрузки.СтранаСсылка.Наименование КАК СтранаНаименование,
	|	СправочникиДляВыгрузки.СтранаСсылка.Код КАК СтранаКод,
	|	СправочникиДляВыгрузки.СтранаСсылка.ИмяПредопределенныхДанных КАК СтранаИмяПредопределенныхДанных,
	|	СправочникиДляВыгрузки.СтранаСсылка.НаименованиеПолное КАК СтранаНаименованиеПолное,
	|	СправочникиДляВыгрузки.СтранаСсылка.КодАльфа2 КАК СтранаКодАльфа2,
	|	СправочникиДляВыгрузки.СтранаСсылка.КодАльфа3 КАК СтранаКодАльфа3,
	|	СправочникиДляВыгрузки.ВидКИСсылка КАК ВидКИСсылка,
	|	СправочникиДляВыгрузки.ВидКИСсылка.ПометкаУдаления КАК ВидКИПометкаУдаления,
	|	СправочникиДляВыгрузки.ВидКИСсылка.Родитель КАК ВидКИРодитель,
	|	СправочникиДляВыгрузки.ВидКИСсылка.ЭтоГруппа КАК ВидКИЭтоГруппа,
	|	СправочникиДляВыгрузки.ВидКИСсылка.Наименование КАК ВидКИНаименование,
	|	СправочникиДляВыгрузки.ВидКИСсылка.Тип КАК ВидКИТип,
	|	СправочникиДляВыгрузки.ВидКИСсылка.РеквизитДопУпорядочивания КАК ВидКИРеквизитДопУпорядочивания,
	|	СправочникиДляВыгрузки.ВидКИСсылка.РедактированиеТолькоВДиалоге КАК ВидКИРедактированиеТолькоВДиалоге,
	|	СправочникиДляВыгрузки.ВидКИСсылка.МожноИзменятьСпособРедактирования КАК ВидКИМожноИзменятьСпособРедактирования,
	|	СправочникиДляВыгрузки.ВидКИСсылка.ТолькоНациональныйАдрес КАК ВидКИАдресТолькоРоссийский,
	|	СправочникиДляВыгрузки.ВидКИСсылка.ВключатьСтрануВПредставление КАК ВидКИВключатьСтрануВПредставление,
	|	СправочникиДляВыгрузки.ВидКИСсылка.ОбязательноеЗаполнение КАК ВидКИОбязательноеЗаполнение,
	|	СправочникиДляВыгрузки.ВидКИСсылка.ПроверятьКорректность КАК ВидКИПроверятьКорректность,
	|	СправочникиДляВыгрузки.ВидКИСсылка.СкрыватьНеактуальныеАдреса КАК ВидКИСкрыватьНеактуальныеАдреса,
	|	"""" КАК ВидКИПодсказка,
	|	СправочникиДляВыгрузки.ВидКИСсылка.РазрешитьВводНесколькихЗначений КАК ВидКИРазрешитьВводНесколькихЗначений,
	|	СправочникиДляВыгрузки.ВидКИСсылка.ИмяПредопределенныхДанных КАК ВидКИИмяПредопределенныхДанных
	|ИЗ
	|	СправочникиДляВыгрузки КАК СправочникиДляВыгрузки
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ Страны
	...
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ ВидыКонтактнойИнформации
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|УНИЧТОЖИТЬ СправочникиДляВыгрузки";
...
//  Фабрика - ФабрикаXDTO - фабрика XDTO для записи объектов;
//  Данные - Объект метаданных - данные, подлежащие записи в формат XML;
		...
		Если СокрЛП(ОписаниеОбъекта.ИмяОбъекта) = "ВариантыОтчетов" Тогда
			...
			Если Не НастройкиПользователя = Неопределено Тогда
				...
				ОбъектОбменаСтрокаТаблицы.ПредставлениеНастройки =
					НСтр("ru = 'Текущие пользовательские настройки'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
...
//
// Параметры:
//  УзелОбмена - ПланОбменаСсылка - узел, для которого необходимо зарегистрировать изменения;
//  ПараметрыОбмена - Структура - структура, содержащая параметры обмена.
//
...
//
// Параметры:
//  Данные - Объект метаданных - Объект, набор записей, который нужно проверить.
//
// Возвращаемое значение:
//  Булево - Истина - необходимо выполнять перенос, иначе - перенос выполнять не нужно.
//
...
//
// Параметры:
//  ВариантАнализа - СправочникСсылка.ВариантыАнализаЦелевыхПоказателей - вариант анализа, сериализованный объект которого требуется получить.
//
// Возвращаемое значение:
//  ХранилищеЗначения - хранилище, содержащее сериализованный объект Вариант анализа.
//
...
//
// Параметры:
//  ВариантОтчета - СправочникСсылка.ВариантыОтчетов - вариант отчета, сериализованный объект которого требуется получить;
//  Настройки - НастройкиКомпоновкиДанных - Настройки вариант отчета, по которым требуется получить результат.
//
// Возвращаемое значение:
//  ХранилищеЗначения - хранилище, содержащее сериализованный объект Вариант отчета.
//
...
//  Партнер - СправочникСсылка.Партнеры - партнер, сериализованный объект которого требуется получить;
//  Версия - Строка - версия мобильного приложения.
//
// Возвращаемое значение:
//  ХранилищеЗначения - хранилище, содержащее сериализованный объект Партнер.
//
...
//
// Параметры:
//  Вариант - СправочникСсылка.ВариантыОтчетов - вариант отчета, который нужно проверить;
//  Подсистема - Ссылка - раздел или группа варианта отчета;
//  Пользователь - СправочникСсылка.Пользователь - пользователь для которого производится проверка.
//
// Возвращаемое значение:
//  Булево - Истина - вариант отчета входит в быстрый доступ, иначе - нет.
//
...
//
// Параметры:
//  ВариантАнализа - СправочникСсылка.ВариантыАнализаЦелевыхПоказателей - вариант анализа, который нужно проверить.
//
// Возвращаемое значение:
//  Булево - Истина - вариант отчета доступен, иначе - вариант отчета не доступен.
//
Функция ВариантАнализаДоступен(ВариантАнализа)
	...
	ЗапросСостава.УстановитьПараметр("ТекущаяДата", ТекущаяДатаСеанса());
	...
	Иначе
		ЗапросСостава.Текст = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
		|	ВариантыАнализаЦелевыхПоказателейНастройкиДоступности.Ссылка КАК ВариантАнализа
		|ИЗ
		|	Справочник.ВариантыАнализаЦелевыхПоказателей.НастройкиДоступности КАК ВариантыАнализаЦелевыхПоказателейНастройкиДоступности
		|ГДЕ
...
//
// Параметры:
//  ВариантОтчета - СправочникСсылка.ВариантыОтчетов - вариант отчета, который нужно проверить.
//
// Возвращаемое значение:
//  Булево - Истина - вариант отчета доступен, иначе - вариант отчета не доступен.
//
Функция ВариантОтчетаДоступен(ВариантОтчета)
	...
	|		КОГДА ВариантыРазмещение.Ссылка.Пользовательский
	|			ТОГДА ВариантыРазмещение.Ссылка.ВидимостьПоУмолчанию
	|		КОГДА ВариантыРазмещение.Ссылка.ПредопределенныйВариант = ЗНАЧЕНИЕ(Справочник.ПредопределенныеВариантыОтчетов.ПустаяСсылка)
	|			ТОГДА ВариантыРазмещение.Ссылка.ВидимостьПоУмолчанию
	...
	|	И ВЫБОР
	|			КОГДА ВариантыРазмещение.Ссылка.ТолькоДляАвтора
	|				ТОГДА ВариантыРазмещение.Ссылка.Автор = &ТекущийПользователь
	|			ИНАЧЕ ИСТИНА
	|		КОНЕЦ
...
// Параметры:
//  ЗаписьXML - ЗаписьXML - сообщение обмена;
//  Клиент - СправочникСсылка.Партнер - клиент, чьих контаткных лиц необходимо выгрузить в обмен;
...
// Возвращает информацию, включающую отношения с партнером,
// табличный документ результата формирования отчета "Досье Партнера",
...
Функция ДосьеПартнера(Партнер, ВыгружатьКонтактныеТелефоны = Истина)
	...
	ПараметрыЖурнала.Вставить("ИмяСобытия", НСтр("ru = 'Монитор ERP. Синхронизация.'",
	...
	Если Не ВыгружатьКонтактныеТелефоны Тогда
		...
		КомментарийСПараметрами = НСтр("ru = 'Досье клиента сформировано успешно.'",
			ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	...
	Запрос.УстановитьПараметр("Ответственный", НСтр("ru = 'Ответственный менеджер'",
		ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()));
	Результат = Запрос.Выполнить();
	Выборка = Результат.Выбрать();
	ЗаголовокТелефон = НСтр("ru = 'тел.:'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка())+" ";
	...
	Пока Выборка.Следующий() Цикл
		...
		ПредставлениеКонтакта = СтрЗаменить(ПредставлениеКонтакта,
			НСтр("ru = 'Телефон'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), ЗаголовокТелефон);
		ПредставлениеКонтакта = СтрЗаменить(ПредставлениеКонтакта,
			НСтр("ru = 'телефон'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()), ЗаголовокТелефон);
...
Функция РезультатВарианта(ВариантАнализа)
	...
	Если Не ИсточникДанных = Неопределено Тогда
		...
		Попытка
			...
			КомментарийСПараметрами = НСтр("ru = 'Показатель сформирован успешно.'",
				ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
		Исключение
		...
		Иначе
			Кратность = "";
		КонецЕсли;
		Если Не ПустаяСтрока(ИсточникДанныхПоказателя.ДинамическиеСвойстваВариантаАнализа.Размерность) Тогда
			Размерность = Строка(ИсточникДанныхПоказателя.ДинамическиеСвойстваВариантаАнализа.Размерность);
		Иначе
			Размерность = "";
		КонецЕсли;
		...
		Если ЗначениеЗаполнено(Размерность) Тогда
			СвойстваПоказателя = СвойстваПоказателя + ?(ЗначениеЗаполнено(СвойстваПоказателя), " ", "") + Размерность;
		КонецЕсли;
	Иначе
		ИнформацияОбОшибке =  НСтр("ru = 'Не определен источник данных для показателя.'",
				ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	КонецЕсли;
	...
	СтруктураРезультата.Вставить("Размерность", СвойстваПоказателя);
...
Функция РезультатОтчета(ВариантОтчета, НастройкиОтчетаХранилище, ПериодОтчета = Неопределено,
	...
	Если ПараметрыОтчета.СКД Тогда
		...
		Если Не ПериодОтчета = Неопределено Тогда
			...
			Если Не ПараметрПериод = Неопределено И Не ПараметрПериод = ПериодОтчета Тогда
	...
	Попытка
		...
		Иначе
			...
			КонецЕсли;
		КонецЕсли;
		КомментарийСПараметрами = НСтр("ru = 'Вариант отчета сформирован успешно.'",
			ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка());
	Исключение
		ИнформацияОбОшибке = ИнформацияОбОшибке();
	КонецПопытки;
