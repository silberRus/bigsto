...
//
// Параметры:
//  СтруктураДанныхКарты - Структура с данными подарочного сертификата, см. функцию ПодарочныеСертификатыВызовСервера.ПолучитьСтруктуруДанныхПодарочногоСертификата().
//
...
//  ТипКода - Перечисление.ТипыКодовКарт - Тип кода карты подарочного сертификата.
//
// Возвращаемое значение:
...
//  Движения - Структура - Коллекция движений.
//  Отказ - Булево - Признак отказа от проведения документа.
//
