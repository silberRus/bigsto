...
Процедура ЗарегистрироватьЭлементыНастроек(Информация, УзелКД, НаборЭлементов, Владелец, Родитель)
	...
	Для Каждого ЭлементКД Из НаборЭлементов Цикл
		...
		Если СвойстваНастройки = Неопределено 
			И (НастройкаВарианта.Тип = "ЭлементОтбора" Или НастройкаВарианта.Тип = "ЗначениеПараметраНастроек") Тогда
...
Процедура ВывестиЭлементыНастройки(Форма, Элементы, СвойстваНастройки, ГруппаВывода, Прочее) Экспорт
	...
	ПараметрыРасположенияЭлементовУправления = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(Форма.НастройкиОтчета, "ПараметрыРасположенияЭлементовУправления");
