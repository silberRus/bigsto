...
// КэшированныеЗначения               - Структура - структура кэшируемых значений, см. ОбработкаТабличнойЧастиКлиентСервер.ПолучитьСтруктуруКэшируемыеЗначения().
//
...
//
// Параметры:
// 	ПараметрыУстановки - Структура - Структура параметров установки, конструктор МногооборотнаяТараСервер.ПараметрыУстановкиУсловногоОформленияДляСтрокСМногооборотнойТарой
//
