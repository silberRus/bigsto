...
//
// Параметры:
//  ТипСобытия  -  ПеречисленияСсылка.ТипыСобытийОповещений - тип события, для которого проверяется использование.
//
...
//
// Параметры:
//  ТипСобытия  -  ПеречисленияСсылка.ТипыСобытийОповещений - тип события, для которого ищутся виды оповещений.
//
// Возвращаемое значение:
