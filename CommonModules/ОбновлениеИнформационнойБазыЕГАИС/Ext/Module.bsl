...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.ИзменяемыеОбъекты = "РегистрСведений.УдалитьПротоколОбменаЕГАИС, Справочник.ЕГАИСПрисоединенныеФайлы";
	...
	Обработчик.ОчередьОтложеннойОбработки = 2;
	Обработчик.ЧитаемыеОбъекты = "РегистрСведений.УдалитьПротоколОбменаЕГАИС, Справочник.ЕГАИСПрисоединенныеФайлы";
	Обработчик.ИзменяемыеОбъекты = "РегистрСведений.УдалитьПротоколОбменаЕГАИС, Справочник.ЕГАИСПрисоединенныеФайлы";
	Обработчик.ЗапускатьТолькоВГлавномУзле = ОбъектМетаданныхВходитВСоставРИБ(Метаданные.РегистрыСведений.УдалитьПротоколОбменаЕГАИС);
	...
	Обработчик.ОчередьОтложеннойОбработки = 2;
	Обработчик.ЧитаемыеОбъекты = "Документ.АктСписанияЕГАИС";
	Обработчик.ИзменяемыеОбъекты = "Документ.АктСписанияЕГАИС";
	Обработчик.ЗапускатьТолькоВГлавномУзле = ЛОЖЬ;
	Обработчик.Комментарий = НСтр("ru = 'Заполняет табличную часть документа ""Акцизные марки"" ссылками на справочник ""Штрихкоды упаковок и товаров"". Данные ссылки используются вместо реквизита строкового типа ""Код акцизной марки"".'");
	Обработчик.ПриоритетыВыполнения = ОбновлениеИнформационнойБазы.ПриоритетыВыполненияОбработчика();
