...
Процедура УстановитьВидимостьНаСервере()
	...
	Элементы.ДатаНачалаВыгрузкиДокументов.Доступность = ?(ПравилаОтправкиДокументов = "АвтоматическаяСинхронизация", Истина, Ложь);
	Элементы.ГруппаРежимОтправкиДокументов.Доступность = ?(Не ПравилаОтправкиСправочников = "СинхронизироватьПоНеобходимости", Истина, Ложь);
	...
	Если ВидимостьГруппы Тогда
		...
		ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементовФормы(
			Элементы,
			"ПереключательДокументыНеОтправлять,ОписаниеДокументыНеОтправлять",
			"Доступность",
	...
	ОбщегоНазначенияУТКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"ОткрытьСписокВыбранныхОрганизаций",
		"Доступность",
		ВидимостьГруппы И ИспользоватьОтборПоОрганизациям);
	#КонецОбласти
	...
	Элементы.ГруппаВыгружатьАналитикуПоСкладам.Видимость = Не ПравилаОтправкиДокументов = "НеСинхронизировать"
		И Не ВариантНастройки = "ОбменУП2ЗУП3";
	#КонецОбласти
