...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Выборка.Следующий() Тогда
		...
		ТЧБыстрыеТовары = Выборка.БыстрыеТовары.Получить();
	...
	Если ДанныеТовара <> Неопределено Тогда
		Оповестить(
			...
			Новый Структура(
				...
				ДанныеТовара.Характеристика,
				ДанныеТовара.Упаковка,
				ДанныеТовара.ТипНоменклатуры,
				1,
...
Функция ДанныеТовара(ИмяКоманды)
	...
	Если НайденныеСтроки.Количество() > 0 Тогда
		...
		Возврат Новый Структура(
			"Номенклатура, Характеристика, Упаковка, ТипНоменклатуры",
