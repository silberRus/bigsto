...
Функция УведомлениеОбОтгрузкеМаркированныхТоваровXML2_40(ДокументСсылка)
	...
	Если Шапка.ВидОборотаТовара <> Перечисления.ВидОборотаТовараГИСМ.ЭкспортВСтраныЕАЭС Тогда
		...
		УведомлениеОбОтгрузкеМаркированныхТоваров = ИнтеграцияГИСМ.ОбъектXDTO(ИмяПакета, Версия);
		...
		УведомлениеОбОтгрузкеМаркированныхТоваров.order_details = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузкеМаркированныхТоваров, "order_details", Версия);
		
		Для Каждого СтрокаТЧ Из Товары Цикл
			
			НоваяСтрока = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузкеМаркированныхТоваров.order_details, "detail", Версия);
	...
	Иначе
		...
		УведомлениеОбЭкспорте = ИнтеграцияГИСМ.ОбъектXDTO(ИмяПакета, Версия);
		...
		УведомлениеОбЭкспорте.transborder = ИнтеграцияГИСМ.ОбъектXDTO("transborder_org", Версия);
		...
		УведомлениеОбЭкспорте.exports = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбЭкспорте, "exports", Версия);
...
Функция УведомлениеОбОтгрузкеМаркированныхТоваровXML2_41(ДокументСсылка)
	...
	Если Шапка.ВидОборотаТовара <> Перечисления.ВидОборотаТовараГИСМ.ЭкспортВСтраныЕАЭС
		...
		Если ИнтеграцияГИСМ.ДокументОснованиеВозвратПоставщику(Шапка.Основание)
			...
			УведомлениеОбОтгрузке = ИнтеграцияГИСМ.ОбъектXDTO(ИмяПакета, Версия);
			...
			УведомлениеОбОтгрузке.action = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузке, "action", Версия);
			УведомлениеОбОтгрузке.action.return2fl = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузке.action, "return2fl", Версия);
			...
			УведомлениеОбОтгрузке.details = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузке, "details", Версия);
			...
			Для Каждого СтрокаТЧ Из Товары Цикл
				...
				НоваяСтрока = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузке.details, "sign", Версия);
		...
		Иначе
			...
			Если Не Шапка.КонтрагентНеЗарегистрированВГИСМ Тогда
				...
				Для Каждого СтрокаТЧ Из Товары Цикл
					...
					НоваяСтрока = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузкеМаркированныхТоваров.order_details, "sign", Версия);
			...
			Иначе
				...
				subject = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузкеМаркированныхТоваров, "subject", Версия);
				...
				Если РеквизитыКонтрагента.ЭтоФизическоеЛицо Тогда
					...
					subject.fl = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(subject, "fl", Версия);
				...
				Иначе
					...
					subject.ul = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(subject, "ul", Версия);
	...
	ИначеЕсли Шапка.ВидОборотаТовара = Перечисления.ВидОборотаТовараГИСМ.ЭкспортВСтраныЕАЭС Тогда
		...
		УведомлениеОбЭкспорте.transborder_info = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбЭкспорте, "transborder_info", Версия);
	...
	ИначеЕсли Шапка.ВидОборотаТовара = Перечисления.ВидОборотаТовараГИСМ.ЭкспортЗаПределыЕАЭС Тогда
		...
		УведомлениеОбОтгрузке.action = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузке, "action", Версия);
		УведомлениеОбОтгрузке.action.export = ИнтеграцияГИСМ.ОбъектXDTOПоИмениСвойства(УведомлениеОбОтгрузке.action, "export", Версия);
		УведомлениеОбОтгрузке.action.export.fts_gtd_info                   = ИнтеграцияГИСМ.ОбъектXDTO("fts_gtd_info_type", Версия);
