...
Процедура ОтметитьОтработкуРасхождений(Команда)
	...
	Если ТекущиеДанные = Неопределено
		ИЛИ ТекущиеДанные.ДальнейшееДействиеЕГАИС1 <> ПредопределенноеЗначение("Перечисление.ДальнейшиеДействияПоВзаимодействиюЕГАИС.ОтработайтеРасхождения") Тогда
...
Процедура ОтметитьОтработкуРасхожденийНаСервере(ДокументСсылка, ВидДокумента)
	...
	НовыйСтатус = Документы.ОтчетЕГАИС.ОбновитьСтатусПослеПолученияДанных(
		ДокументСсылка, Операция,
