...
//
// Параметры:
//  ОписаниеПериода - структура, содержащая следующие элементы:
...
//
// Параметры:
//  УсловияПродаж - структура, содержащая данные условий продаж. Свойства структуры:
//  	* Валюта - СправочникСсылка.Валюты - используемая валюта.
//  	* ХозяйственнаяОперация - ПеречислениеСсылка.ХохяйственныеОперации - хозяйственная операция.
//  	* ГрафикОплаты - СправочникСсылка.ГрафиуиОплаты - график оплаты.
...
Процедура ЗаполнитьУсловияПродаж(УсловияПродаж) Экспорт
	...
	ДокументПродажи.НалогообложениеНДС = УсловияПродаж.НалогообложениеНДС;
	...
	ДатаНачала = ?(ЗначениеЗаполнено(ДокументПродажи.Дата),ДокументПродажи.Дата,ТекущаяДатаСеанса());
...
Процедура ЗаполнитьДокументПоДаннымСоглашения() Экспорт
	...
	НалогообложениеНДС = СтруктураУсловийСоглашения.НалогообложениеНДС;
