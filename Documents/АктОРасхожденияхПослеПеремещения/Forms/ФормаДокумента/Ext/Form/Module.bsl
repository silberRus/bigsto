...
Процедура ЗаполнитьПоПриемкеСервер()
	...
	ТаблицаНакладная = Документы.АктОРасхожденияхПослеПеремещения.ДанныеТаблицыТоварыДокумента(Объект.Ссылка, ОрдернаяСхемаПриОтгрузке, ИспользоватьОрдернуюСхемуСкладПолучатель);
