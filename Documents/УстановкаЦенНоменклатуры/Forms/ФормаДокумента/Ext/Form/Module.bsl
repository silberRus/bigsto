...
Функция ДобавитьНоменклатуруПоШтрихкодамВДеревоЦен(ДанныеШтрихкодов)
	...
	ДанныеДляРасчетаВычисляемыхЦенНаКлиенте = УстановкаЦенСервер.ДобавитьТоварыПоОтбору(ЭтаФорма, Неопределено, ТаблицаНоменклатура);
...
Функция ОбработкаВыбораПодборНаСервере(ВыбранноеЗначение)
	...
	ДанныеДляРасчетаВычисляемыхЦенНаКлиенте = УстановкаЦенСервер.ДобавитьТоварыПоОтбору(ЭтаФорма, Неопределено, ТаблицаТоваров);
...
Функция ДеревоЦенНоменклатураПриИзмененииСервер(ИдентификаторСтроки, РассчитатьЦены = Истина)
	...
	ТаблицаЗначений = УстановкаЦенСервер.СоздатьТаблицуТовары(Ложь);
...
Функция ПолучитьСтрокиИзБуфераОбмена(ЗаполняемыйВидЦен)
	...
	ДанныеДляРасчетаВычисляемыхЦенНаКлиенте = УстановкаЦенСервер.ДобавитьТоварыПоОтбору(ЭтаФорма, Неопределено, ТаблицаТоваров, ЗаполняемыйВидЦен);
