...
Функция ЗаявкаНаВыпускКиЗXML2_41(ДокументСсылка)
	...
	Если Шапка.СпособПолучения = Перечисления.СпособыПолученияИзготовленныхКИЗГИСМ.ЧерезМногофункциональныйЦентр
		...
		РезультатПолученияИдентификаторовАдреса = АдресныйКлассификатор.ИдентификаторыАдреса(Шапка.АдресДоставки);
		Если Не РезультатПолученияИдентификаторовАдреса.Отказ
...
Функция ДобавитьКомандуСоздатьНаОсновании(КомандыСозданияНаОсновании) Экспорт
	Если ПравоДоступа("Добавление", Метаданные.Документы.ЗаявкаНаВыпускКиЗГИСМ) Тогда
		...
		КомандаСоздатьНаОсновании.Представление = ОбщегоНазначенияУТ.ПредставлениеОбъекта(Метаданные.Документы.ЗаявкаНаВыпускКиЗГИСМ);
