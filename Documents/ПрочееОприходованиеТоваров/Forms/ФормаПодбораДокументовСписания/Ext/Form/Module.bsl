...
Процедура ВосстановитьНастройки()
	...
	ЗначениеНастроек = ОбщегоНазначения.ХранилищеОбщихНастроекЗагрузить("Документ.ВнутреннееПотреблениеТоваров", "ПодборДокументовСписания");
...
Процедура СохранитьНастройкиИЗаполнитьСписок()
	...
	ОбщегоНазначения.ХранилищеОбщихНастроекСохранить("Документ.ВнутреннееПотреблениеТоваров", "ПодборДокументовСписания", Настройки);
