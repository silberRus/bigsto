...
Процедура ПерезаполнитьНаСервере()
	...
	ОтчетОРозничныхПродажахОбъект = РеквизитФормыВЗначение("Объект", Тип("ДокументОбъект.ОтчетОРозничныхПродажах"));
...
Процедура ОбновитьСтатусГИСМ()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(
		...
		"Видимость",
		Объект.ЕстьМаркируемаяПродукцияГИСМ);
...
Процедура СформироватьТекстДокументаЕГАИС()
	...
	ИнтеграцияЕГАИСУТ.СформироватьТекстДокументаЕГАИС(ЭтаФорма, Истина);
