...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Запись.ВариантАнализа.Владелец.ЦелевойТренд = Перечисления.ВидыЦелевыхТрендовПоказателей.Диапазон Тогда
...
Функция ПриведенноеГраничноеНегативноеОтклонение()
	...
	Тренд = Запись.ВариантАнализа.Владелец.ЦелевойТренд;
...
Процедура УстановитьЕдиницыИзмеренияОтклонений()
	...
	Размерность = Запись.ВариантАнализа.Владелец.Размерность;
