...
Функция ОтправитьPUTОтвет(Запрос)
	...
	Если Ответ = Неопределено Тогда
		...
		Иначе
			...
			ОписаниеДанных = Новый Структура("ИмяФайла, Данные", ИмяФайла, ИсходныйЗапрос["ИмяВременногоФайла"]);
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(НСтр("ru = 'ПередачаДанных'"), УровеньЖурналаРегистрации.Ошибка,,, ПодробноеПредставлениеОшибки(ИнформацияОбОшибке()));
