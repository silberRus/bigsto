...
Функция Корзина_ПроверитьPOST(Запрос)	Возврат ВернутьОтвет(Запрос, АТ_WI.Корзина_ПроверитьPOST(Запрос)) КонецФункции
...
Функция ПоискPOST(Запрос)			Возврат ВернутьОтвет(Запрос, АТ_WI.ПоискPOST(Запрос)) КонецФункции
Функция ПоискГУИДPOST(Запрос)		Возврат ВернутьОтвет(Запрос, АТ_WI.ПоискГУИДPOST(Запрос)) КонецФункции
