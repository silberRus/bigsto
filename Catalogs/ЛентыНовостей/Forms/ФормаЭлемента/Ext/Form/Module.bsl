...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтотОбъект.ДоступныРазделенныеДанные = Истина;
	Если ОбщегоНазначения.РазделениеВключено() Тогда
		...
		Если (НЕ ОбщегоНазначения.ДоступноИспользованиеРазделенныхДанных()) Тогда
			ЭтотОбъект.ДоступныРазделенныеДанные = Ложь;
		КонецЕсли;
	КонецЕсли;

	Элементы.ДоступныеКатегорииНовостейСписокЗначенийОтборовДляОбластиДанных.Видимость = ЭтотОбъект.ДоступныРазделенныеДанные;

	Элементы.ДекорацияВидимостьДляОбластиДанных.Видимость = Ложь;
	Если НЕ Параметры.Ключ.Пустая() Тогда
		Если ЭтотОбъект.ДоступныРазделенныеДанные = Истина Тогда
...
Процедура УправлениеФормой(Форма)
	...
	Если (Форма.РольДоступнаАдминистратор)
		...
		Если Форма.ДоступныРазделенныеДанные = Истина Тогда
