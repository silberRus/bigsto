...
Процедура УстановитьУсловноеОформление()
	...
	ОтборЭлемента.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
	ОтборЭлемента.ПравоеЗначение = Перечисления.ТипыПодключаемогоОборудования.ККМОфлайн;
...
Процедура ЗагрузитьНастройкиОтбораПоУмолчанию()
	...
	Если Объект.ТипПодключаемогоОборудования = Перечисления.ТипыПодключаемогоОборудования.ККМОфлайн Тогда
...
Процедура ЗагрузитьКодыИзРегистра(ТекущийОбъект)
	...
	Таблица = ПодключаемоеОборудованиеOfflineВызовСервера.ПолучитьТаблицуТоваровДляПравила(ТекущийОбъект.Ссылка, ТекущийОбъект.Склад.РозничныйВидЦены);
...
&НаСервере
Процедура ОбновитьТаблицуТоваров(КодыТоваров, ПравилоОбмена, ВидЦены, АдресНаНастройки)
...
Процедура ОбновитьСписокТоваровНаСервереПовторноеОткрытие()
	...
	ОбновитьТаблицуТоваров(Товары, Объект.Ссылка, Объект.Склад.РозничныйВидЦены, АдресКомпоновщикаНастроекВоВременномХранилище());
