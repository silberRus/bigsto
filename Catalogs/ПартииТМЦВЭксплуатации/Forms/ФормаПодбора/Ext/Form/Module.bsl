...
Процедура СписокВыборЗначения(Элемент, Значение, СтандартнаяОбработка)
	...
	Для Каждого ЭлементМассива Из ВыбранныйМассив Цикл
		...
		ВыбранноеЗначение = Новый Структура("Номенклатура, Характеристика, ПартияТМЦВЭксплуатации, ФизическоеЛицо, Количество, КоличествоУпаковок, ИнвентарныйУчет");
