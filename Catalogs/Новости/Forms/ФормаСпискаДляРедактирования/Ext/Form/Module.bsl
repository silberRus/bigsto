...
Функция СформироватьПараметрыОткрытияФормыРедактированияНовости(Ключ, Копирование, ЗначениеКопирования, СтатусНовостиНаСервере)
	...
	ПараметрыОткрытия.Вставить("ТаблицаМетаданных", ЭтаФорма.ТаблицаМетаданных);
	ПараметрыОткрытия.Вставить("ЗакрыватьПриЗакрытииВладельца", Истина);
	ПараметрыОткрытия.Вставить("БезАвторизации", Истина);
	ПараметрыОткрытия.Вставить("БуферОбмена_КатегорииПростые", ЭтаФорма.БуферОбмена_КатегорииПростые);
	ПараметрыОткрытия.Вставить("БуферОбмена_КатегорииИнтервалыВерсий", ЭтаФорма.БуферОбмена_КатегорииИнтервалыВерсий);
	ПараметрыОткрытия.Вставить("РазрешенныеДляРедактированияЛентыНовостей", ЭтаФорма.РазрешенныеДляРедактированияЛентыНовостей);
