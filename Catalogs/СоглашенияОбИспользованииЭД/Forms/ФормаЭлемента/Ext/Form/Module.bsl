...
Процедура ИсходящиеДокументыПриИзменении(Элемент)
	...
	Если ВРег(Элемент.ТекущийЭлемент.Имя) = ВРег("ИсходящиеДокументыДокументУчета") Тогда
		ОбновитьФлагиРегламентаПоСтроке(Элемент.ТекущиеДанные, Объект.ИспользоватьУПД, Объект.ИспользоватьУКД);
		ЗаполнитьПредставлениеНастроек(Объект);
	КонецЕсли;
...
Процедура ИсходящиеДокументыВерсияФорматаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТекСтрока <> Неопределено Тогда
		...
		ИсходящийДокумент = ТекСтрока.ИсходящийДокумент;
		СпособОбменаЭД = ТекСтрока.СпособОбменаЭД;
		СписокДоступныхВерсий = ОбменСКонтрагентамиСлужебныйКлиент.ДоступныеВерсииФорматаПоПараметрамЭД(ИсходящийДокумент
									,СпособОбменаЭД, Объект.ИспользоватьУПД, Объект.ИспользоватьУКД);
...
Процедура ИсходящиеДокументыВерсияФорматаНачалоВыбораЗавершить(ВыбранныйЭлемент, ТекущиеДанные) Экспорт 
	...
	ОбменСКонтрагентамиСлужебныйКлиентСервер.ПриИзмененииФорматаВСтрокеНастроек(ТекущиеДанные, Истина);
...
Процедура ОбновитьФлагиРегламентаПоСтроке(Строка, ИспользоватьУПД, ИспользоватьУКД)
	...
	ЭтоПрямойОбмен = Строка.СпособОбменаЭД = ПредопределенноеЗначение("Перечисление.СпособыОбменаЭД.ЧерезКаталог")
		Или Строка.СпособОбменаЭД = ПредопределенноеЗначение("Перечисление.СпособыОбменаЭД.ЧерезЭлектроннуюПочту")
		Или Строка.СпособОбменаЭД = ПредопределенноеЗначение("Перечисление.СпособыОбменаЭД.ЧерезFTP");
...
Процедура ЗаполнитьСоответствиеВидовИТипов(СоответствиеВидовИТипов)
	...
	Для Каждого СтрокаВидаЭД Из Объект.ВходящиеДокументы Цикл
		СписокВыбора = ОбменСКонтрагентамиСлужебный.СписокОперацийВидаЭД(СтрокаВидаЭД.ВходящийДокумент, Истина,
