...
Процедура ОформитьПодпискуДляМассиваСуществующихИНовыхПодписок(Подписки) Экспорт
	...
	Если СуществующиеПодписки.Количество() > 0 Тогда
		ОформитьПодпискуДляМассиваСущестующих(СуществующиеПодписки);
	КонецЕсли;
...
//
Процедура ОформитьПодпискуДляМассиваСущестующих(МассивПодписок) Экспорт
	...
	Пока Выборка.Следующий() Цикл
		...
		ПодпискаОбъект = Выборка.Ссылка.ПолучитьОбъект();
