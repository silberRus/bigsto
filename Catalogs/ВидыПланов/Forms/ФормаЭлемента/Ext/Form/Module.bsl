...
Процедура УстановитьВидимость(Форма)
	...
	ЭтоПланЗапкупок = ТипПлана = ПредопределенноеЗначение("Перечисление.ТипыПланов.ПланЗакупок");
	...
	Форма.Элементы.ЗаполнятьПодразделение.Видимость = ЭтоПланЗапкупок ИЛИ ЭтоПланПродаж ИЛИ ЭтоПланПродажПоКатегориям;
	Форма.Элементы.ЗаполнятьПодразделениеПроизводство.Видимость = ЭтоПланПроизводства;
	...
	Форма.Элементы.ЗаполнятьПартнераЗакупки.Видимость = ЭтоПланЗапкупок;
	Форма.Элементы.ГруппаЗаполнятьПартнераВТЧ.Видимость = НЕ Форма.Объект.ЗаполнятьПоФормуле И (ЭтоПланЗапкупок ИЛИ ЭтоПланПродаж);
	Форма.Элементы.ЗаполнятьПартнераВТЧПродажи.Видимость = ЭтоПланПродаж;
	Форма.Элементы.ЗаполнятьПартнераВТЧЗакупки.Видимость = ЭтоПланЗапкупок;
	...
	Форма.Элементы.ГруппаЗаполнятьСоглашениеВТЧ.Видимость = НЕ Форма.Объект.ЗаполнятьПоФормуле И (ЭтоПланЗапкупок И Форма.ИспользоватьСоглашенияСПоставщиками ИЛИ ЭтоПланПродаж И Форма.ИспользоватьСоглашенияСКлиентами);
	Форма.Элементы.ЗаполнятьСоглашениеВТЧПродажи.Видимость = ЭтоПланПродаж И Форма.ИспользоватьСоглашенияСКлиентами;
	Форма.Элементы.ЗаполнятьСоглашениеВТЧЗакупки.Видимость = ЭтоПланЗапкупок И Форма.ИспользоватьСоглашенияСПоставщиками;
	...
	Форма.Элементы.ЗаполнятьСклад.Видимость = ЭтоПланЗапкупок ИЛИ ЭтоПланСборкиРазборки ИЛИ ВыборСклада И (ЭтоПланПродаж ИЛИ ЭтоПланПродажПоКатегориям);
	Форма.Элементы.ГруппаЗаполнятьСкладВТЧ.Видимость = НЕ Форма.Объект.ЗаполнятьПоФормуле И (ЭтоПланЗапкупок ИЛИ ЭтоПланСборкиРазборки ИЛИ ВыборСклада И (ЭтоПланПродаж  ИЛИ ЭтоПланПродажПоКатегориям));
	Форма.Элементы.ВарианЗаполненияСкладФорматМагазина.Видимость = ВыборСкладаИлиФорматам И (ЭтоПланПродаж ИЛИ ЭтоПланПродажПоКатегориям);
	Форма.Элементы.ЗаполнятьПланОплатПродажи.Видимость = ЭтоПланПродаж;
	Форма.Элементы.ЗаполнятьПланОплатЗакупки.Видимость = ЭтоПланЗапкупок;
	...
	Форма.Элементы.ДекорацияДетализацияПояснениеЗакупки.Видимость = ЭтоПланЗапкупок;
	Форма.Элементы.ДекорацияДетализацияПояснениеПродажи.Видимость = ЭтоПланПродаж;
	Форма.Элементы.ДекорацияДетализацияПояснениеПодажиПоКатегориям.Видимость = ЭтоПланПродажПоКатегориям;
	...
	Форма.Элементы.ГруппаОтражениеВБюджетировании.Видимость = Форма.ОтражаетсяВБюджетировании И Форма.ПравоПросмотраСтатейБюджетов;
