...
//
// Параметры:
// ХозяйственнаяОперация - ПеречислениеСсылка.ХозяйственныеОперации - Хозяйственная операция, для которой определяется тип договора.
//
// Возвращаемое значение:
...
// Ищет документ регистрации для договора.
//
// Параметры:
//  Договор - СправочникСсылка.ДоговорыКонтрагентов - ссылка на договор, для которого необходимо создать документ
//
// Возвращаемое значение:
//  ДокументСсылка.РегистраторГрафикаДвиженияТоваров - ссылка на документ
//
Функция ПолучитьДокументРегистрации(Договор) Экспорт
...
//  ДокументСсылка.РегистраторГрафикаДвиженияТоваров - ссылка на документ
//
Функция ПолучитьСоздатьДокументРегистрации(Договор) Экспорт
	
	Результат = ПолучитьДокументРегистрации(Договор);
	...
	Если Не ЗначениеЗаполнено(Результат) Тогда
		...
		РегистраторГрафикаДвиженияТоваров.Распоряжение = Договор;
