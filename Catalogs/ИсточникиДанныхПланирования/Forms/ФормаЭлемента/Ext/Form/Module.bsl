...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Исключение
		ЗаписьЖурналаРегистрации(НСтр("ru = 'Компановка настроек источника данных планирования'", ОбщегоНазначенияКлиентСервер.КодОсновногоЯзыка()),
...
Функция РекомендуемаяВыборкаПоПериоду(СхемаКомпоновкиДанных)
	...
	Если СхемаКомпоновкиДанных.Параметры.Найти("Период") <> Неопределено Тогда
