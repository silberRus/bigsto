...
Процедура ЗаполнитьУсловияПродаж(Знач УсловияПродаж) Экспорт
	...
	Если НЕ УсловияПродаж.НалогообложениеНДСПоДаннымОрганизации Тогда
...
Процедура ИнициализироватьСправочник(ЗаполнятьВсеРеквизиты = Истина)
	...
	Если ЗаполнятьВсеРеквизиты Тогда
		...
		ПорядокОплаты = Перечисления.ПорядокОплатыПоСоглашениям.ПолучитьПорядокОплатыПоУмолчанию(ВалютаВзаиморасчетов, НалогообложениеНДС);
