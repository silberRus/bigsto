...
// Предназначена для получения текста запроса временной таблицы "ВтДатыПлановойПоставки", которая содержит даты плановой поставки по способу обеспечения,
// для способов обеспечения перечисленных во временной таблице "ВтСпособыОбеспечения".
//
// Параметры:
...
// Предназначена для получения даты заказа для обеспечения своевременной поставки на определенную дату (дату поставки) исходя из срока исполнения заказа
//
// Параметры:
