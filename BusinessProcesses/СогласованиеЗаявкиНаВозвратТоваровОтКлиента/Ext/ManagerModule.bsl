...
//
// Параметры:
//   БизнесПроцесс - БизнесПроцессаСсылка.СогласованиеЗаявкиНаВозвратТоваровОтКлиента - текущий бизнес-процесс согласования.
...
//
// Параметры:
//  БизнесПроцесс - БизнесПроцессаСсылка.СогласованиеЗаявкиНаВозвратТоваровОтКлиента - бизнес-процесс, для предмета которого получается номер версии.
//
// Возвращаемое значение:
...
//
// Параметры:
//   БизнесПроцесс - БизнесПроцессаСсылка.СогласованиеЗаявкиНаВозвратТоваровОтКлиента - бизнес-процесс, версии предмета которого проверяются.
//
// Возвращаемое значение:
...
Процедура ДобавитьКомандыОтчетов(КомандыОтчетов, Параметры) Экспорт
	...
	КомандаОтчет = ВариантыОтчетовУТПереопределяемый.ДобавитьКомандуРезультатыСогласованияЗаявкиНаВозвратТоваровОтКлиента(КомандыОтчетов);
