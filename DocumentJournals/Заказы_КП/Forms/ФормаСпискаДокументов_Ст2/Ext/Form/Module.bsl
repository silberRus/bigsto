...
&НаКлиенте
Перем СтатусГотов, СтатусОтгружен;
...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	Элементы.СформироватьРеализацию.Видимость 	= текДанные <> Неопределено И текДанные.Статус = СтатусГотов;
	Элементы.ПечатьКомплекта.Видимость 			= текДанные <> Неопределено И текДанные.Статус = СтатусОтгружен;
