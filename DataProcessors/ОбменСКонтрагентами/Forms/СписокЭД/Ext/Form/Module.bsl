...
Процедура ВывестиДокументИКартинку(СтрокаДерева, Макет, ЭтоТекущийДокумент = Ложь, ЭтоПодчиненный = Неопределено)
	...
	Если ЭтоТекущийДокумент Тогда
		...
		Иначе
			...
			КонецЕсли;
		КонецЕсли;
		ЭлектронноеВзаимодействиеСлужебный.ВывестиОбластьВТабличныйДокумент(ТаблицаОтчета, ОбластьКартинка, "Картинка");
	Иначе
		...
		Иначе
			...
			КонецЕсли;
		КонецЕсли;
		ЭлектронноеВзаимодействиеСлужебный.ПрисоединитьОбластьКТабличномуДокументу(ТаблицаОтчета, ОбластьКартинка,
			"Картинка");
	КонецЕсли;
	...
	ЭлектронноеВзаимодействиеСлужебный.ПрисоединитьОбластьКТабличномуДокументу(ТаблицаОтчета, ОбластьДокумент,
		"Документ");
	...
	Для каждого СтрокаДерева Из СтрокиДерева Цикл
		...
		Для Счетчик = 1 По УровеньРекурсии Цикл
			...
			Если Счетчик = 1 Тогда
				ЭлектронноеВзаимодействиеСлужебный.ВывестиОбластьВТабличныйДокумент(ТаблицаОтчета, Область, "ТекущаяОбласть",
					Счетчик);
			Иначе
				ЭлектронноеВзаимодействиеСлужебный.ПрисоединитьОбластьКТабличномуДокументу(ТаблицаОтчета, Область,
					"ТекущаяОбласть", Счетчик);
			КонецЕсли;
		КонецЦикла;
