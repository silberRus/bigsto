...
Функция ВидЭДСтрокой(ВидЭД, ТипЭлементаВерсииЭД)
	...
	Если ВидЭД = ПредопределенноеЗначение("Перечисление.ВидыЭД.СчетФактура") Тогда
		Если ТипЭлементаВерсииЭД = ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.ЭСФ") Тогда
	...
	ИначеЕсли ВидЭД = ПредопределенноеЗначение("Перечисление.ВидыЭД.ТОРГ12Продавец") Тогда
		Если ТипЭлементаВерсииЭД = ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.ПервичныйЭД") Тогда
			ВидЭДСтрокой = НСтр("ru = 'ТоварнаяНакладнаяТОРГ12'");
		ИначеЕсли ТипЭлементаВерсииЭД = ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.ДОПУПД") Тогда
			ВидЭДСтрокой = НСтр("ru = 'УПД'");
		Иначе
			ВидЭДСтрокой = НСтр("ru = 'ПередачаТоваров'");
		КонецЕсли;
		
	ИначеЕсли ВидЭД = ПредопределенноеЗначение("Перечисление.ВидыЭД.АктИсполнитель") Тогда
		Если ТипЭлементаВерсииЭД = ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.ПервичныйЭД") Тогда
	...
	ИначеЕсли ВидЭД = ПредопределенноеЗначение("Перечисление.ВидыЭД.СоглашениеОбИзмененииСтоимостиОтправитель")
		И ТипЭлементаВерсииЭД = ПредопределенноеЗначение("Перечисление.ТипыЭлементовВерсииЭД.ДИСУКД") Тогда
		ВидЭДСтрокой = НСтр("ru = 'УКД'");
		...
		Иначе
			...
			Иначе
				...
				Для Каждого Строка Из ТаблицаВыбранныхДокументов Цикл
					...
					Структура.Вставить("ВидДокумента", ВидЭДСтрокой(Строка.ВидЭД, Строка.ТипЭлементаВерсииЭД));
