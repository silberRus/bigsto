...
Процедура ПриОткрытии(Отказ)
	...
	Элементы.ДекорацияABCКлассификацияОписание.Заголовок = НСтр("ru = 'По данным за период:'") + " " + ОписаниеНастройки(ПериодABCКлассификации, КоличествоПериодовABCКлассификации);
	Элементы.ДекорацияXYZКлассификацияОписание.Заголовок = НСтр("ru = 'По данным за период:'") + " " + ОписаниеНастройки(ПериодXYZКлассификации, КоличествоПериодовXYZКлассификации, ПодпериодXYZКлассификации);
