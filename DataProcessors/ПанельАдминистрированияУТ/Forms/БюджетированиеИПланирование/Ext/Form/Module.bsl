...
Функция СохранитьЗначениеРеквизита(РеквизитПутьКДанным, Результат)
	...
	Если КонстантаИмя = "ИспользоватьПланированиеПродаж"
		Или КонстантаИмя = "ИспользоватьПланированиеЗакупок"
		Или КонстантаИмя = "ИспользоватьПланированиеСборкиРазборки" Тогда
		
		Если УправлениеТорговлей 
			И (НаборКонстант.ИспользоватьПланированиеПродаж
			Или НаборКонстант.ИспользоватьПланированиеПродажПоКатегориям
			Или НаборКонстант.ИспользоватьПланированиеЗакупок
			Или НаборКонстант.ИспользоватьПланированиеСборкиРазборки) Тогда
			
			Константы.ИспользоватьСбалансированностьПлановУТ.Установить(Истина);
			
		Иначе
			
			Константы.ИспользоватьСбалансированностьПлановУТ.Установить(Ложь);
