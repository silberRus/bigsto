...
Процедура НазваниеГеографическойСхемыДляОтчетовНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	СписокВыбора.Добавить("ГеографическаяСхемаРоссияРегионыИСтолицы", НСтр("ru = 'Регионы России'"),, ГеоКартинка);
	СписокВыбора.Добавить("ГеографическаяСхемаРоссияРегионыИВсеГорода", НСтр("ru = 'Регионы России и города'"),, ГеоКартинка);
	СписокВыбора.Добавить("ГеографическаяСхемаКартаМира", НСтр("ru = 'Карта мира'"),, ГеоКартинка);
