...
Процедура СтраницыПриСменеСтраницы(Элемент, ТекущаяСтраница)
	...
	НавигацияПоНоменклатуреПоставщика = (Элементы.Страницы.ТекущаяСтраница = Элементы.СтраницаНоменклатураПоставщика);
	Если НавигацияПоНоменклатуреПоставщика 
		И ИспользоватьФильтрНоменклатураПоставщика Тогда
		Если ТекущаяИерархияНоменклатурыПоставщика = Неопределено Тогда
			ТекущаяИерархияНоменклатурыПоставщика = Элементы.ИерархияНоменклатурыПоставщика.ТекущаяСтрока;
		КонецЕсли;
		ПодборТоваровКлиентСервер.УстановитьОтборПоИерархииНоменклатурыПоставщика(ЭтаФорма);
	КонецЕсли;
