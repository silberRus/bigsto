...
Функция ПечатьТТНСправкаРазделБ(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	ПустойКонтрагент = ИнтеграцияЕГАИС.ПустоеЗначениеОпределяемогоТипа(Метаданные.ОпределяемыеТипы.ОрганизацияКонтрагентЕГАИС.Имя);
	...
	Запрос.УстановитьПараметр("ПустаяОрганизация"       , ИнтеграцияЕГАИС.ПустоеЗначениеОпределяемогоТипа(Метаданные.ОпределяемыеТипы.ОрганизацияКонтрагентЕГАИС.Имя));
...
Процедура ЗаполнитьТабличныйДокументТТНСправкаРазделБ(ТабличныйДокумент, Запрос, ОбъектыПечати)
	...
	Пока ДанныеПечати.Следующий() Цикл
		...
		СведенияОПродавце = Новый Структура("ПолноеНаименование, ФактическийАдрес, ИНН, КПП", "", "", "", "");
		ГосударственныеИнформационныеСистемыПереопределяемый.ЗаполнитьСведенияОбОрганизации(ДанныеПечати.Продавец, СведенияОПродавце, ДанныеПечати.ДатаТТН);
		
		СведенияОПокупателе = Новый Структура("ПолноеНаименование, ФактическийАдрес, ИНН, КПП", "", "", "", "");
		ГосударственныеИнформационныеСистемыПереопределяемый.ЗаполнитьСведенияОбОрганизации(ДанныеПечати.Покупатель, СведенияОПокупателе, ДанныеПечати.ДатаТТН);
		...
		РуководительПродавца = ГосударственныеИнформационныеСистемыПереопределяемый.ДанныеРуководителяОрганизации(ДанныеПечати.Продавец, ДанныеПечати.ДатаТТН);
		...
		РуководительПокупателя = ГосударственныеИнформационныеСистемыПереопределяемый.ДанныеРуководителяОрганизации(ДанныеПечати.Покупатель, ДанныеПечати.ДатаТТН);
