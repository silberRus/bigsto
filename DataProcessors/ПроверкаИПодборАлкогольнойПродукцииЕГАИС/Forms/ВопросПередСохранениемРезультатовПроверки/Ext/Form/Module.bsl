...
Процедура ОК(Команда)
	...
	Если КакУчитыватьНеПроверенныеОтложенные = 0 Тогда
		ВозвращаемоеЗначение = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияАлкогольнойПродукции.Отсутствует");
	Иначе
		ВозвращаемоеЗначение = ПредопределенноеЗначение("Перечисление.СтатусыПроверкиНаличияАлкогольнойПродукции.ВНаличии");
	КонецЕсли;
...
Процедура ПоказатьВопросПоМаркируемой(Форма)
	...
	Если Форма.КоличествоВсего <> 0 
		...
		КакУчитыватьНеПроверенныеОтложенные = 1;
