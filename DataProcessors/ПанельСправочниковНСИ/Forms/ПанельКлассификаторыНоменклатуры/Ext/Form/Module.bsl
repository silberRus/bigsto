...
Процедура ОткрытьВидыАлкогольнойПродукции(Команда)
	...
	ОткрытьФорму("Справочник.ВидыАлкогольнойПродукции.ФормаСписка", , ЭтаФорма);
...
&НаКлиенте
Процедура ОткрытьКлассификаторВидовЭкономическойДеятельности(Команда)
	ОткрытьФорму("Справочник.КлассификаторВидовЭкономическойДеятельности.ФормаСписка", , ЭтаФорма);
КонецПроцедуры
...
&НаКлиенте
Процедура ОткрытьОбщероссийскийКлассификаторПродукции(Команда)
	ОткрытьФорму("Справочник.ОбщероссийскийКлассификаторПродукции.ФормаСписка", , ЭтаФорма);
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьКлассификаторОКПД2(Команда)
	ОткрытьФорму("Справочник.КлассификаторОКПД2.ФормаСписка", , ЭтаФорма);
КонецПроцедуры

&НаКлиенте
Процедура ОткрытьКлассификаторОКВЭД2(Команда)
	ОткрытьФорму("Справочник.КлассификаторОКВЭД2.ФормаСписка", , ЭтаФорма);
КонецПроцедуры
...
Процедура УправлениеЭлементами()
	...
	Элементы.ДекорацияВидыМехаГИСМ.Видимость = ПравоДоступаКлассификаторВидыМехаГИСМ И ВестиУчетМаркировкиПродукцииВГИСМ;
	// Конец ИнтеграцияГИСМ
