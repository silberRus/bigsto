...
//
// Параметры:
//  Объект           - ДанныеФормыСтруктура        - реквизит формы документа, содержащий объект, в списке товаров которого необходимо заполнить обеспечение.
...
//    * Количество         - Число                                  - значение реквизита "Количество" для переноса в строку списка.
//    * ВариантОбеспечения - ПеречислениеСсылка.ВариантыОбеспечения - значение реквизита "Вариант обеспечения" для переноса в строку списка.
//    * Склад              - СправочникСсылка.Склады                - значение реквизита "Склад" для переноса в строку списка, используется, например для заполнения по группе складов.
