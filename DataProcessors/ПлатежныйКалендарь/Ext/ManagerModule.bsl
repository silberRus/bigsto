...
Процедура ПеренестиЗаявки(Параметры, АдресРезультата) Экспорт
	...
	ОписаниеЗамера = ОценкаПроизводительности.НачатьЗамерДлительнойОперации("ПланированиеИКонтрольДенежныхСредств.ПереносЗаявокНаРасходованиеДенежныхСредствВПлатежномКалендаре");
