...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("НеЗаписыватьДвижения") Тогда
		...
		Элементы.НадписьВыполняетсяЗаполение.Заголовок = НСтр("ru = 'Выполняется тестирование'") + "...";
	КонецЕсли;
...
Процедура Далее(Команда)
	...
	Если Элементы.СтраницыФормы.ТекущаяСтраница = Элементы.СтраницаРезультат Тогда
		...
		Оповестить("Запись_НаборКонстант", "ОбновитьИнтерфейс", "ФормироватьУправленческийБаланс");
		Закрыть("ОК");
