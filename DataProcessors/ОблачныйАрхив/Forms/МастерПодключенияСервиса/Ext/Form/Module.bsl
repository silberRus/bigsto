...
#Область ЗагрузкаФайлаИнсталляции
		...
		Если НеобходимаЗагрузка = Истина Тогда
			...
			РезультатЗагрузки = ПолучениеФайловИзИнтернета.СкачатьФайлНаСервере(
...
// Функция возвращает структуру данных для механизма замены.
//
// Параметры:
//  ОткрывающийТег - Строка;
//  ЗакрывающийТег - Строка;
//  ЧемЗаменять    - Строка;
//  Условие        - Булево.
//
// Возвращаемое значение:
...
//
&НаКлиентеНаСервереБезКонтекста
Функция ДанныеЗамены(ОткрывающийТег, ЗакрывающийТег, ЧемЗаменять, Условие)

	Результат = Новый Структура;
	Результат.Вставить("ОткрывающийТег", ОткрывающийТег);
	Результат.Вставить("ЗакрывающийТег", ЗакрывающийТег);
	Результат.Вставить("ЧемЗаменять",    ЧемЗаменять);
