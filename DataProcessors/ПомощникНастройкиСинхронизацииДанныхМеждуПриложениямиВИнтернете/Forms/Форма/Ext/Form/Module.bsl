...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ВерсияБСП243 Тогда
		...
		ЗначенияНастроекПланаОбмена = МодульОбменДаннымиСервер.ЗначениеНастройкиПланаОбмена(ИмяПланаОбмена,
									"ПодробнаяИнформацияПоОбмену, ПояснениеНастройкиПараметровУчета,
									|ПояснениеДляНастройкиПараметровУчетаБазыКорреспондента",
									ВариантНастройкиОбмена, ВерсияКорреспондента);
		СсылкаНаПодробноеОписание = ЗначенияНастроекПланаОбмена.ПодробнаяИнформацияПоОбмену;
		
		ПараметрыУчетаПоясняющаяНадпись = ЗначенияНастроекПланаОбмена.ПояснениеНастройкиПараметровУчета;
		ПараметрыУчетаКорреспондентаПоясняющаяНадпись = ЗначенияНастроекПланаОбмена.ПояснениеДляНастройкиПараметровУчетаБазыКорреспондента;
		
		МодульОбменДаннымиСервер.ОбщиеДанныеУзлов(ИмяПланаОбмена, ВерсияКорреспондента, "", ФормаНастройкиУзлов);
	...
	Иначе
		...
		ПараметрыУчетаКорреспондентаПоясняющаяНадпись = МодульОбменДаннымиСервер.ПояснениеДляНастройкиПараметровУчетаБазыКорреспондента(ИмяПланаОбмена, ВерсияКорреспондента);
		
		ОбменДаннымиСервер.ОбщиеДанныеУзлов(ИмяПланаОбмена, ВерсияКорреспондента, ФормаНастройкиУзлов);
		
	КонецЕсли;
	
	ЗначенияПоУмолчаниюНаУзле = ОбменДаннымиСервер.ЗначенияПоУмолчаниюНаУзле(ИмяПланаОбмена, ВерсияКорреспондента, ФормаНастройкиЗначенийПоУмолчанию, ВариантНастройкиОбмена);
	ЗначенияПоУмолчаниюНаУзлеБазыКорреспондента = ОбменДаннымиСервер.ЗначенияПоУмолчаниюНаУзлеБазыКорреспондента(ИмяПланаОбмена, ВерсияКорреспондента, ФормаНастройкиЗначенийПоУмолчаниюБазыКорреспондента, ВариантНастройкиОбмена);
	НастройкаОтборовНаУзле = ОбменДаннымиСервер.НастройкаОтборовНаУзле(ИмяПланаОбмена, ВерсияКорреспондента, , ВариантНастройкиОбмена);
	...
	Попытка
		ТаблицыКорреспондента = МодульОбменДаннымиСервер.ТаблицыКорреспондентаДляЗначенийПоУмолчанию(ИмяПланаОбмена, ВерсияКорреспондента, ВариантНастройкиОбмена);
	Исключение
	...
	Заголовок = СтрШаблон(НСтр("ru = 'Настройка синхронизации данных с ""%1""'"), НаименованиеКорреспондента);
	Элементы.ОписаниеСинхронизацииДанных.Заголовок = СтрШаблон(НСтр("ru = 'Описание синхронизации данных с ""%1""'"), НаименованиеКорреспондента);
...
Процедура ПриОткрытии(Отказ)
	...
	Если ПредусмотреныНастройкиОтборовНаУзле Тогда
		...
		ПараметрыФормы.Вставить("ИдентификаторНастройки", ВариантНастройкиОбмена);
...
Процедура ОжиданиеАнализаДанных_ОбработкаДлительнойОперации(Отказ)
	...
	Попытка
		...
		Если ТипЗнч(КонтекстФормыНастройкиУзлов) = Тип("Структура") Тогда
			
			Если КонтекстФормыНастройкиУзлов.Свойство("НастройкаОтборовНаУзле")
				И ТипЗнч(КонтекстФормыНастройкиУзлов.НастройкаОтборовНаУзле) = Тип("Структура") Тогда
				ПараметрыМетода.НастройкаОтборовНаУзле.НастройкаОтборовНаУзле.Вставить("ВариантНастройки", ВариантНастройкиОбмена);
			КонецЕсли;
			
			Если КонтекстФормыНастройкиУзлов.Свойство("НастройкаОтборовНаУзлеБазыКорреспондента")
				И ТипЗнч(КонтекстФормыНастройкиУзлов.НастройкаОтборовНаУзлеБазыКорреспондента) = Тип("Структура") Тогда
				ПараметрыМетода.НастройкаОтборовНаУзле.НастройкаОтборовНаУзлеБазыКорреспондента.Вставить("ВариантНастройки", ВариантНастройкиОбмена);
			КонецЕсли;
