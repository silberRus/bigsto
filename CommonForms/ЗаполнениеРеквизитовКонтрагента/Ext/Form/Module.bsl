...
Процедура НайтиРеквизитыНаСервере(ОписаниеОшибки)
	...
	Если ПоискПоИНН Тогда
		Если ПоискЮридическогоЛица Тогда
			НайденныеРеквизиты = РаботаСКонтрагентами.РеквизитыЮридическогоЛицаПоИНН(СтрокаПоиска);
		Иначе
			НайденныеРеквизиты = РаботаСКонтрагентами.РеквизитыПредпринимателяПоИНН(СтрокаПоиска);
		КонецЕсли;
	Иначе
		НайденныеРеквизиты = РаботаСКонтрагентами.РеквизитыЮридическихЛицПоНаименованию(СтрокаПоиска, Регион, Адрес);
	КонецЕсли;
