...
Процедура СформироватьОтчет(ПараметрыОтчета, АдресХранилища) Экспорт
	...
	ИнформацияОПроверках = РаботаСКонтрагентами.ИнформацияОПроверкахКонтролирующимиОрганамиПоИНН(
...
Функция ПериодыБухгалтерскойОтчетности()
	...
	Результат = Новый Структура;
	Результат.Вставить("Год_1", "2016");
	Результат.Вставить("Год_2", "2015");
	Результат.Вставить("Год_3", "2014");
	Результат.Вставить("КонецГода_1", Формат(Дата(2016,12,31), "ДЛФ=DD"));
	Результат.Вставить("КонецГода_2", Формат(Дата(2015,12,31), "ДЛФ=DD"));
	Результат.Вставить("КонецГода_3", Формат(Дата(2014,12,31), "ДЛФ=DD"));
	Возврат Результат;
