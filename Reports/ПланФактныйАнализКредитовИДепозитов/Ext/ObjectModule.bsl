...
Процедура ПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Параметры.Свойство("ПараметрКоманды") Тогда
		...
		Валюта = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ЭтаФорма.ФормаПараметры.Отбор.Договор, "ВалютаВзаиморасчетов");
		ЭтаФорма.ФормаПараметры.Отбор.Вставить("Валюта", Валюта);
