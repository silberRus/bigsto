...
Процедура УстановитьНадписьКоличествоКолонокМонитораПоказателей(КоличествоКолонокМонитораПоказателей, Элементы)
	...
	Иначе
		...
		ОбщегоНазначенияУТКлиентСервер.СклонениеСлова(
			...
			НСтр("ru= 'колонка'"), НСтр("ru= 'колонки'"), НСтр("ru= 'колонок'"), "ж");
...
Процедура УстановитьЗаголовокФормы()
	АвтоЗаголовок = Ложь;
	Если Параметры.НастройкаВыбранныхВариантовАнализа Тогда
		Заголовок = НСтр("ru= 'Варианты анализа'");
	Иначе
		Заголовок = НСтр("ru= 'Персональные настройки'");
	КонецЕсли; 
КонецПроцедуры
...
Процедура ОбновитьПользовательскиеНастройкиКомпоновщика()
	ВыбранныеВариантыАнализаРасширенные = РеквизитФормыВЗначение("СохраняемыеВариантыАнализа");
