...
Процедура УстановитьОбязательныеНастройки(ПользовательскиеНастройкиМодифицированы)
	...
	ИскомоеПоле.Выражение = "Период" + ОбщегоНазначения.ИмяЗначенияПеречисления(ПараметрПериодичность.Значение);
	...
	Если ПараметрВалютаРегламентированногоУчета <> Неопределено 
		И НЕ (ЗначениеЗаполнено(ПараметрВалютаРегламентированногоУчета.Значение)
			ИЛИ ТипЗнч(ПараметрВалютаРегламентированногоУчета.Значение) = Тип("Строка")) Тогда
