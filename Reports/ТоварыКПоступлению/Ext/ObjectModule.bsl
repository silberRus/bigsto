...
Процедура ПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Параметры.Свойство("ПараметрКоманды")
		...
		Если Параметры.ОписаниеКоманды.ДополнительныеПараметры.ИмяКоманды = "ТоварыКПоступлениюПоРаспоряжению" Тогда
			РеквизитыДокумента = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Параметры.ПараметрКоманды, "Распоряжение, Склад");
			
			ЭтаФорма.ФормаПараметры.Отбор.Вставить("Склад",        РеквизитыДокумента.Склад);
			ЭтаФорма.ФормаПараметры.Отбор.Вставить("Распоряжение", РеквизитыДокумента.Распоряжение);
		КонецЕсли;
