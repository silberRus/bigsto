...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	ТекстЗапроса = СхемаКомпоновкиДанных.НаборыДанных.НаборДанных.Элементы.ТоварыКОформлениюОтчетовКомитенту.Запрос;
	...
	СхемаКомпоновкиДанных.НаборыДанных.НаборДанных.Элементы.ТоварыКОформлениюОтчетовКомитенту.Запрос = ТекстЗапроса;

	ТекстЗапроса = СхемаКомпоновкиДанных.НаборыДанных.НаборДанных.Элементы.УслугиКОформлениюОтчетовПринципалу.Запрос;
	...
	СхемаКомпоновкиДанных.НаборыДанных.НаборДанных.Элементы.УслугиКОформлениюОтчетовПринципалу.Запрос = ТекстЗапроса;
