...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	СтруктураЗначений = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(ПараметрСценарий.Значение, "Периодичность, ПланированиеПоНазначениям, ПланПродажПланироватьПоСумме");
	...
	КомпоновкаДанныхКлиентСервер.УстановитьПараметр(КомпоновщикНастроек, "ПланироватьПоСумме", СтруктураЗначений.ПланПродажПланироватьПоСумме);
	
	Период = КомпоновкаДанныхКлиентСервер.ПолучитьПараметр(КомпоновщикНастроек, "ПериодПродажи");
	...
	ТекстЗапроса = СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоКлиентам.Схема.НаборыДанных.НаборДанных1.Запрос;

	ТекстЗапроса = СтрЗаменить(
		ТекстЗапроса, 
		"&ТекстЗапросаВесНоменклатуры", 
		Справочники.УпаковкиЕдиницыИзмерения.ТекстЗапросаВесУпаковки("ПланПродажФакт.Номенклатура.ЕдиницаИзмерения", "ПланПродажФакт.Номенклатура"));
		
	ТекстЗапроса = СтрЗаменить(
		ТекстЗапроса, 
		"&ТекстЗапросаОбъемНоменклатуры", 
		Справочники.УпаковкиЕдиницыИзмерения.ТекстЗапросаОбъемУпаковки("ПланПродажФакт.Номенклатура.ЕдиницаИзмерения", "ПланПродажФакт.Номенклатура"));

	СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоКлиентам.Схема.НаборыДанных.НаборДанных1.Запрос = ОбработатьЗапрос(ТекстЗапроса);
	...
	СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоПодразделениям.Схема.НаборыДанных.НаборДанных1.Запрос = ОбработатьЗапрос(ТекстЗапроса);
	...
	СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоСкладам.Схема.НаборыДанных.НаборДанных1.Запрос = ОбработатьЗапрос(ТекстЗапроса);

	ТекстЗапроса = СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоМенеджерам.Схема.НаборыДанных.НаборДанных1.Запрос;
	...
	СхемаКомпоновкиДанных.ВложенныеСхемыКомпоновкиДанных.ПоМенеджерам.Схема.НаборыДанных.НаборДанных1.Запрос = ОбработатьЗапрос(ТекстЗапроса);
...
Функция ОбработатьЗапрос(ТекстЗапроса)
	...
	Возврат СтрЗаменить(
				ТекстЗапроса,
				"ПланПродажФакт.Номенклатура.ЕдиницаИзмерения",
				"ВЫРАЗИТЬ(ПланПродажФакт.Номенклатура.ЕдиницаИзмерения КАК Справочник.УпаковкиЕдиницыИзмерения)");
КонецФункции
