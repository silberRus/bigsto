...
Процедура ЗаполнитьТаблицыВыбранныхПолей()
	...
	НоваяСтрокаТаблицы(ВыбранныеПоляПартнера,НСтр("ru = 'Публичное наименование'"),НСтр("ru = 'НаименованиеПолное'"));
	Если ПолучитьФункциональнуюОпцию("ИспользоватьБизнесРегионы") Тогда
		 НоваяСтрокаТаблицы(ВыбранныеПоляПартнера,НСтр("ru = 'Бизнес-регион'"),НСтр("ru = 'БизнесРегион'"));
	КонецЕсли;
	НоваяСтрокаТаблицы(ВыбранныеПоляПартнера,НСтр("ru = 'Основной менеджер'"),НСтр("ru = 'ОсновнойМенеджер'"));
	НоваяСтрокаТаблицы(ВыбранныеПоляПартнера,НСтр("ru = 'Дата регистрации'"),НСтр("ru = 'ДатаРегистрации'"));
	Если ПравоДоступа("Просмотр", Метаданные.РегистрыСведений.ABCXYZКлассификацияКлиентов) Тогда
		НоваяСтрокаТаблицы(ВыбранныеПоляПартнера,НСтр("ru = 'ABC\XYZ классификация'"),НСтр("ru = 'Классификация'"));
	КонецЕсли;
