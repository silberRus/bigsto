...
//	JobType - ТипыЗаданий - ОбъектXDTO - тип складского задания,
...
//
// Возвращаемое значение:
//	ТаблицаЗаданий - ОбъектXDTO - таблица заданий заданного вида.
//
...
//
// Возвращаемое значение:
//	ПараметрыЗадания - ОбъектXDTO - параметры складского задания:
...
//
// Возвращаемое значение:
//	ПараметрыСпискаЯчеек - ОбъектXDTO - параметры складских ячеек:
//		Успешно - Булево, Истина - данные складского задания получены,
//		ТекстСообщения - Строка - информационное сообщение,
//		ЗоныПриемкиОтгрузки - ОбъектXDTO - таблица складских ячеек.
//
Функция GetTableOfAcceptanceAreas(IdWarehouse, IdStorage)
...
//
// Возвращаемое значение:
//	ПараметрыТоваровЯчейки - ОбъектXDTO - параметры товаров, хранящихся в ячейке:
//		Успешно - Булево, Истина - данные складского задания получены,
//		ТекстСообщения - Строка - информационное сообщение,
...
// Параметры:
//	IdJob - Строка- идентификатор документа складского задания,
//	ScannedGoods - ТаблицаОтсканированныхТоваров - отсканированные товары складского задания.
//
// Возвращаемое значение:
//	ПараметрыОбработкиОтсканированныхТоваров - ОбъектXDTO - параметры обработка отобранных товаров складской 
//	 операции "Перемещение":
//		Успешно - Булево, Истина - данные складского задания получены,
//		ТекстСообщения - Строка - информационное сообщение,
...
//
// Возвращаемое значение:
//	ПараметрыОтменыВыполненияЗадания - ОбъектXDTO - параметры складского задания 
//	 операции "Перемещение":
//		Успешно - Булево, Истина - данные складского задания получены,
//		ТекстСообщения - Строка - информационное сообщение.
//
...
//	ScannedGoods - ТаблицаОтсканированныхТоваров - отсканированные товары складского задания,
//	JobType - ТипыЗаданий - ОбъектXDTO - тип складского задания,
//	AdditionalOptions - ПараметрыЗавершенияПеремещения - ОбъектXDTO - параметры завершения складской операции 
//		"Перемещение".
//
// Возвращаемое значение:
//	ПараметрыЗавершенияСкладскогоЗадания - ОбъектXDTO - параметры складского задания 
//	 операции "Перемещение":
//		Успешно - Булево, Истина - данные складского задания получены,
//		ТекстСообщения - Строка - информационное сообщение,
...
//	IdWarehouse - Строка- идентификатор склада,
//	IdStorage - Строка- идентификатор помещения,
//	IdAcceptanceDock - Строка - идентификато складской ячейки зоны приемки,
//	IdExecutor - Строка- идентификатор исполнителя складского задания,
//	ScannedGoods - ТаблицаОтсканированныхТоваров - отсканированные товары складского задания.
//
// Возвращаемое значение:
...
//			складской операии "Проверка отбора".
//
