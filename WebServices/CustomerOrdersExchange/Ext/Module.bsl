...
//  Permit - ОбъектXDTO - содержит структуру ответа:
...
//
// Возвращаемое значение:
//  Settings - ОбъектXDTO - содержит структуру ответа:
//  ResultMessage - строка - информационное сообщение;
//  Success - булево - флаг успешного завершения;
...
//
// Возвращаемое значение:
//  MessageExchange - ОбъектXDTO - содержит структуру ответа:
//  ResultMessage - строка - информационное сообщение;
//  Success - булево - флаг успешного завершения.
//
...
//  Customer - строка - выгрузка информации по конкретному партенру.
//
// Возвращаемое значение:
//  MessageExchange - ОбъектXDTO - содержит структуру ответа:
//  ResultMessage - строка - информационное сообщение;
