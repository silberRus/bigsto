...
//
// Состав ключей описан в ОбработкаНовостейКлиентСервер.ПолучитьОписаниеПолейБуфераОбмена().
//
////////////////////////////////////////////////////////////////////////////////
		...
		Если ТипЗнч(Настройки) = ТипСписокЗначений Тогда
			Для каждого ТекущееЗначение Из Настройки Цикл
				Если ТипЗнч(ТекущееЗначение.Значение) = ТипСтруктура Тогда
					НовоеТекущееЗначение = ОбработкаНовостейКлиентСервер.ПолучитьОписаниеПолейБуфераОбмена(КлючОбъекта);
				...
				Если ТипЗнч(ТекущееЗначение.Значение) = ТипСтруктура Тогда
					...
					Если ТекущееЗначение.Значение.Свойство("ПараметрыДействий")
						...
						Для каждого ТекущийПараметрДействия Из ТекущееЗначение.Значение.ПараметрыДействий Цикл
							НовоеТекущееЗначениеПараметраДействий = ОбработкаНовостейКлиентСервер.ПолучитьОписаниеПолейБуфераОбмена("Документы.Новости.ПараметрыДействий");
